package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_22:String = "client.init.volter.fail";
      ...
      private function onVolterLoadingFailedAgain(param1:IOErrorEvent) : void
      {
         ...
         Habbo.reportCrash("Failed to download Volter.swf!",const_21,new Error(param1.text));
      }
      ...
      {
         trackLoginStep(const_8);
         reportCrash("Failed to finalize main swf preloading: " + param1.text + " / HTTP status: " + var_3,const_9,null);
      }
