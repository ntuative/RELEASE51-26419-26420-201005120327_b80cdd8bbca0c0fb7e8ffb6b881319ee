package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private function prepareCore() : void
      {
         ...
         {
            _loc1_.addEventListener(AssetLoaderEvent.const_35,configLoadedHandler);
            _loc1_.addEventListener(AssetLoaderEvent.const_49,configLoadedHandler);
         }
      }
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_35,configLoadedHandler);
         _loc2_.removeEventListener(AssetLoaderEvent.const_49,configLoadedHandler);
      ...
      private function initializeCore() : void
      {
         ...
         catch(error:Error)
         {
            ...
            Core.crash("Failed to initialize the core: " + error.message,Core.const_900,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            Habbo.trackLoginStep(Habbo.const_28);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_900,error);
            Core.dispose();
         }
      }
