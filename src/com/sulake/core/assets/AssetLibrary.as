package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1270:String = "AssetLibraryUnloaded";
      
      public static const const_450:String = "AssetLibraryLoaded";
      
      public static const const_1313:String = "AssetLibraryLoadError";
       
      
      private var var_500:XML;
      ...
      private var var_499:Boolean = true;
      
      private var var_354:Class;
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_417)
         {
            _loc4_ = AssetTypeDeclaration(var_417[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_500 = _loc2_.manifest.copy();
         var_354 = _loc2_.resource;
         if(var_499)
         {
            AssetLibrary.fetchLibraryContents(this,var_500,var_354);
         }
         var_305 = true;
         dispatchEvent(new Event(AssetLibrary.const_450));
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_418[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_35,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_49,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_847,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_852,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_981,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_906,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_418[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_417.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_417[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1033.splice(var_1033.indexOf(this),1);
            --var_595;
            var_418 = null;
            var_698 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_355.length ? getAssetByName(var_355[param1]) : null;
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         {
            _loc3_ = AssetTypeDeclaration(var_417[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_15 == null)
            {
               var_15 = new LibraryLoader(var_1416);
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_500.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_354[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_418[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_35:
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_355.splice(var_355.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_417[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_354 != null ? false : false;
      }
   }
}
