package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         var_653 = param2 == null ? "" : param2.url;
         _type = param1;
         var_15 = new Loader();
         var_968 = new LoaderContext();
         var_968.checkPolicyFile = true;
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_384 < var_2375)
            {
               ...
               var_15.load(new URLRequest(var_653 + (var_653.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_384),var_968);
               return true;
            }
         }
         return false;
