package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected var var_1138:uint;
      
      protected var _isDisposed:Boolean = false;
      
      protected var var_964:String = "";
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = var_189.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            var_964 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_964);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1138 & const_904)
         {
            if(_loc3_ == 0)
            {
               if(var_189.getTotalReferenceCount() == 0)
               {
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         while(_loc8_ < _loc7_)
         {
            _loc6_ = var_189.getStructByIndex(_loc8_);
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_446 + "]";
      }
