package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1051:int = 5;
      ...
      protected var var_1128:Boolean = true;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_354 = this.getDefinition(_name) as Class;
         if(var_354 == null)
         {
         ...
         try
         {
            xmlClass = var_354.manifest as Class;
            if(xmlClass == null)
            {
               return;
            }
         ...
         var_500 = new XML(bytes.readUTFBytes(bytes.length));
      }
