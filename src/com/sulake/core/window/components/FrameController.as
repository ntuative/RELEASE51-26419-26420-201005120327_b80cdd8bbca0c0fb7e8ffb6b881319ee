package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1064:String = "_HEADER";
      
      private static const const_763:String = "margin_right";
      
      private static const const_1065:String = "_SCALER";
      
      private static const const_1062:String = "_TITLE";
      
      private static const const_1063:String = "_CONTENT";
      
      private static const const_764:String = "margin_left";
      
      private static const const_762:String = "margin_bottom";
      ...
      private var var_1155:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_764,_loc3_.left,PropertyStruct.const_66,_loc2_));
         _loc1_.push(new PropertyStruct(const_765,_loc3_.top,PropertyStruct.const_66,_loc2_));
         _loc1_.push(new PropertyStruct(const_763,0 - _loc3_.right,PropertyStruct.const_66,_loc2_));
         _loc1_.push(new PropertyStruct(const_762,0 - _loc3_.bottom,PropertyStruct.const_66,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_260);
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1155 == null)
         {
            var_1155 = findChildByTag(const_1064) as IHeaderWindow;
            if(!var_1155)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1062) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1065) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_250,false);
         }
      ...
      {
         return content != null && var_1403 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1063) as IWindowContainer;
            if(!var_20)
            {
