package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1429:Boolean = false;
      ...
      protected static const const_1430:Boolean = true;
      
      protected static const const_1056:String = "auto_arrange_items";
      ...
      protected var var_2373:Number = 0;
      
      protected var var_558:Boolean = false;
      
      protected var var_2374:Number = 0;
      
      protected var var_559:Number;
      
      protected var var_1133:Boolean = false;
      
      protected var var_560:Number;
      ...
      protected var var_787:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_92 = 0;
         var_69 = 0;
         _horizontal = param2 == WindowType.const_343;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_164 = var_657 || !testParamFlag(WindowParam.const_36);
         _container = var_16.create("_CONTAINER","",WindowType.const_303,WindowStyle.const_320,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         _container.addEventListener(WindowEvent.const_48,containerEventHandler);
         _container.addEventListener(WindowEvent.const_479,containerEventHandler);
         _container.addEventListener(WindowEvent.const_252,containerEventHandler);
         _container.addEventListener(WindowEvent.const_486,containerEventHandler);
         resizeOnItemUpdate = var_1133;
      }
      ...
      {
         return new Rectangle(var_559 * maxScrollH,var_560 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_479,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_252,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_486,containerEventHandler);
         super.dispose();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1054,_spacing,PropertyStruct.const_66,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1056,var_787,PropertyStruct.const_61,var_787 != const_1430));
         _loc1_.push(new PropertyStruct(const_1053,var_558,PropertyStruct.const_61,var_558 != const_1429));
         _loc1_.push(new PropertyStruct(const_1055,var_1133,PropertyStruct.const_61,var_1133 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_560 = param1;
            _container.y = -var_560 * maxScrollV;
            var_16.invalidate(_container,visibleRegion,WindowRedrawFlag.const_79);
         }
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1055:
                  ...
                  break;
               case const_1056:
                  var_787 = _loc2_.value as Boolean;
                  break;
            }
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_487,param1);
            }
            else
            {
