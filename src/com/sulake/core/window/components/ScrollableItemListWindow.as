package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_792:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_336)
         {
            ...
            if(var_336)
            {
               var_336.addEventListener(WindowEvent.const_286,scrollBarEventProc);
               var_336.addEventListener(WindowEvent.const_238,scrollBarEventProc);
            }
         }
         return var_336;
      }
      ...
      override public function dispose() : void
      {
         if(var_336)
         {
            var_336.removeEventListener(WindowEvent.const_286,scrollBarEventProc);
            var_336.removeEventListener(WindowEvent.const_238,scrollBarEventProc);
            var_336 = null;
         }
         if(var_792)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_238)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_792)
         {
            var_792 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_792;
      }
