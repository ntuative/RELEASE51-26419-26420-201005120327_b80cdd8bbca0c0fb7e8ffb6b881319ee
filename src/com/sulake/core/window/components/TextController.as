package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2377:Rectangle = new Rectangle();
       
      
      protected var var_215:Boolean;
      
      protected var var_70:TextMargins;
      
      protected var var_561:String = "none";
      
      protected var var_658:Number;
      ...
      {
         return new Rectangle(var_658 * maxScrollH,var_385 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_788)
         {
            context.removeLocalizationListener(var_333,this);
         }
         if(var_70 != null)
         {
            var_70.dispose();
      ...
      {
         var_658 = param1;
         _field.scrollH = var_658 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_333 = param1;
         if(var_333.charAt(0) == "$" && var_333.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_333.slice(2,var_333.indexOf("}")),this);
            var_788 = true;
         }
         else if(_field != null)
         {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!var_215)
         {
            if(param2.type == WindowNotifyEvent.const_160)
            {
               refreshTextImage();
            }
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_1015,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_466,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_466,true));
         ...
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_66,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_632,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_632,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_left",var_70.left,PropertyStruct.const_66,true));
         _loc1_.push(new PropertyStruct("margin_top",var_70.top,PropertyStruct.const_66,true));
         _loc1_.push(new PropertyStruct("margin_right",var_70.right,PropertyStruct.const_66,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_70.bottom,PropertyStruct.const_66,true));
         _loc1_.push(new PropertyStruct("auto_size",var_561,PropertyStruct.STRING,var_561 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_632,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_658 = var_658;
         _loc1_.var_385 = var_385;
         _loc1_.var_70 = var_70.clone(_loc1_.setTextMargins);
         _loc1_.var_561 = var_561;
         _loc1_.var_788 = var_788;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_561 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_561 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_561 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_561 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
