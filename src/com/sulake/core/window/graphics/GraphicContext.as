package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_912:uint = 256;
      
      protected static var var_660:uint = 0;
      
      protected static var var_386:uint = 0;
      
      public static const const_957:uint = 2;
      
      public static const const_1492:uint = 128;
      
      public static const const_1690:uint = 64;
      
      public static const const_544:uint = 4;
      
      public static const const_1253:uint = 0;
      
      public static const const_1363:uint = 16;
      
      public static const const_526:uint = 1;
      
      public static const const_1348:uint = 8;
       
      
      protected var _disposed:Boolean = false;
      
      protected var var_652:Boolean;
      
      protected var var_1629:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1348:
               ...
               break;
            case GraphicContext.const_1363:
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(var_652)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_386 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
         ...
         if(var_652)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_386 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1629,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1629,16777215);
                  }
                  var_386 += bitmap.width * bitmap.height * 4;
               }
