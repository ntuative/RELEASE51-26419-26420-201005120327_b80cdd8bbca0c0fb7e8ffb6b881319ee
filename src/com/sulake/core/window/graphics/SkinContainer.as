package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_687 = new Dictionary();
         var_686 = new Dictionary();
         var_1456 = new Dictionary();
         var_1817 = new Dictionary();
         TypeCodeTable.fillTables(var_1456,var_1817);
         var_1196 = new Dictionary();
         var_1816 = new Dictionary();
         StateCodeTable.fillTables(var_1196,var_1816);
         var_482 = new Dictionary();
         var_482["skin"] = BitmapSkinRenderer;
         var_482["bitmap"] = BitmapDataRenderer;
         var_482["fill"] = FillSkinRenderer;
         var_482["text"] = TextSkinRenderer;
         var_482["shape"] = ShapeSkinRenderer;
         var_482["unknown"] = SkinRenderer;
         var_482["null"] = NullSkinRenderer;
         if(var_387 == null)
         {
            var_387 = new Array();
            var_387.push(WindowState.const_70);
            var_387.push(WindowState.const_72);
            var_387.push(WindowState.const_98);
            var_387.push(WindowState.WINDOW_STATE_SELECTED);
            var_387.push(WindowState.const_85);
            var_387.push(WindowState.const_80);
            var_387.push(WindowState.const_103);
            var_387.push(WindowState.const_94);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1196)
         {
            _loc3_.push(var_1196[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1456[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_686[param1];
      ...
      {
         var _loc3_:Array = var_687[param1];
         return _loc3_ != null ? _loc3_[param2] : null;
      }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_687[param1] = new Array(SkinContainer.const_779);
         }
         var_687[param1][param2] = param3;
         if(true)
         {
            var_686[param1] = new Array(SkinContainer.const_779);
         }
         var_686[param1][param2] = param4;
      }
