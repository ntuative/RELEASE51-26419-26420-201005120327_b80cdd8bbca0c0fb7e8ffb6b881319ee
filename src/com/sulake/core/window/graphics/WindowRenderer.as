package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1568:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_627 = new Array();
         var_1569 = new Point();
         var_1568 = new Rectangle();
         var_320 = new Rectangle();
         var_321 = new Dictionary(true);
         var_689 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_321[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_627.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = getWindowRendererItem(_loc1_);
               var_320.x = _loc3_.dirty.x;
               var_320.y = _loc3_.dirty.y;
               var_320.width = _loc3_.dirty.width;
               var_320.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_320);
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_518,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_321[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1569,var_1568))
            {
               if(param2.render(param1,var_1569,var_1568))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_689);
            var_321[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_518,windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_320.x = param2.x - param1.x;
            var_320.y = param2.y - param1.y;
            var_320.width = param2.width;
            var_320.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_36))
            {
               while(param1.testParamFlag(WindowParam.const_36))
               {
                  ...
                  var_320.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_320,WindowRedrawFlag.const_262);
            if(var_627.indexOf(param1) == -1)
            {
               var_627.push(param1);
            }
         }
