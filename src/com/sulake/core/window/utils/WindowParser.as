package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1634:String = "_INCLUDE";
      
      public static const const_1025:String = "_EXCLUDE";
      
      public static const const_1497:String = "_TEMP";
      
      private static const const_1083:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1084:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1130:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_963:Dictionary;
      
      protected var var_1404:Map;
      
      protected var var_16:IWindowContext;
      
      protected var var_1405:Dictionary;
      
      protected var var_1129:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         var_1130 = new Dictionary();
         TypeCodeTable.fillTables(var_1129,var_1130);
         var_963 = new Dictionary();
         var_1405 = new Dictionary();
         ParamCodeTable.fillTables(var_963,var_1405);
         var_1404 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1084,"");
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1129)
            {
               delete var_1129[_loc1_];
            }
            for(_loc1_ in var_1130)
            {
               delete var_1130[_loc1_];
            }
            for(_loc1_ in var_963)
            {
               delete var_963[_loc1_];
            }
            for(_loc1_ in var_1405)
            {
               delete var_1405[_loc1_];
            }
            var_1404.dispose();
            var_1404 = null;
            var_16 = null;
