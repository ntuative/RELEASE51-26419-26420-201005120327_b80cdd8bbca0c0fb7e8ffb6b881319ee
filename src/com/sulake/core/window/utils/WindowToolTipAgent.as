package com.sulake.core.window.utils
{
   ...
   public class WindowToolTipAgent extends WindowMouseOperator implements IWindowToolTipAgentService
   {
      ...
      override public function end(param1:IWindow) : IWindow
      {
         ...
         {
            var_334.stop();
            var_334.removeEventListener(TimerEvent.TIMER,showToolTip);
            var_334 = null;
         }
         hideToolTip();
      ...
      override public function operate(param1:int, param2:int) : void
      {
         if(_window && true)
         {
            ...
            {
               var_248.x = param1 + var_1136.x;
               var_248.y = param2 + var_1136.y;
            }
         }
      }
      ...
      protected function showToolTip(param1:TimerEvent) : void
      {
         ...
         if(_window && true)
         {
            ...
            {
               var_248 = _window.context.create("undefined::ToolTip",var_972,WindowType.const_312,_window.style,0 | 0,null,null,null,0,null,null) as IToolTipWindow;
            }
            _loc2_ = new Point();
            _window.getGlobalPosition(_loc2_);
            var_248.x = _loc2_.x + var_1137.x + var_1136.x;
            var_248.y = _loc2_.y + var_1137.y + var_1136.y;
         }
      }
      ...
      override public function begin(param1:IWindow, param2:uint = 0) : IWindow
      {
         if(param1 && !param1.disposed)
         {
            ...
            if(var_972 != null && var_972 != "")
            {
               if(var_334 == null)
               {
                  var_334 = new Timer(var_971,1);
                  var_334.addEventListener(TimerEvent.TIMER,showToolTip);
               }
               var_334.reset();
               var_334.start();
            }
