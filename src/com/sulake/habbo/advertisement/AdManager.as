package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_869:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_372,0,0,_loc4_,var_1515,var_869,var_870));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2000 = int(_config.getKey("interstitial.interval","30000"));
         var_1999 = int(_config.getKey("interstitial.show.time","5000"));
         var_1517 = int(_config.getKey("interstitial.max.displays.flash","-1"));
         ...
         if(_loc3_ != "" && _loc4_ != "")
         {
            ...
            _loc7_.addEventListener(AssetLoaderEvent.const_35,adWarningLeftReady);
            _loc6_ = new URLRequest(_loc4_);
            _loc7_ = _assets.loadAssetFromFile("adWarningRight",_loc6_,"image/png");
            _loc7_.addEventListener(AssetLoaderEvent.const_35,adWarningRightReady);
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1282 = _loc2_.imageUrl;
         var_1515 = _loc2_.clickUrl;
         if(var_1282 != "" && var_1515 != "")
         {
            _loc3_ = var_1282;
            ...
            _loc4_ = new URLRequest(var_1282);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
            _loc5_.addEventListener(AssetLoaderEvent.const_35,roomAdImageReady);
         }
      }
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1281 = _loc2_.imageUrl;
         var_1998 = _loc2_.clickUrl;
         var_722 = getTimer();
         if(var_1281 != "")
         {
            _loc3_ = var_1281;
            ...
            var_234.start();
            _loc4_ = new URLRequest(var_1281);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
            _loc5_.addEventListener(AssetLoaderEvent.const_35,interstitialLoaderEventHandler);
            _loc5_.addEventListener(AssetLoaderEvent.const_49,interstitialLoaderEventHandler);
         }
         else
         {
            stopInterstitial();
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_395,0,0,param1.bitmapData,var_1998));
            var_722 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_870 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1517 > 0 && var_1516 >= var_1517)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_722;
         if(_loc1_ > var_2000)
         {
            ++var_1516;
      ...
      {
         var_308 = param2 as IHabboCommunicationManager;
         if(var_308 == null)
         {
            return;
         }
         _connection = var_308.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_453));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_869 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
