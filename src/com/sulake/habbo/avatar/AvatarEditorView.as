package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1627:IWindowContainer;
      
      public static var var_1400:IWindowContainer;
      
      public static var var_2293:int = 6710886;
       
      
      private var var_1435:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array)
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_988 = [];
         var_1072 = [AvatarEditorFigureCategory.const_560,AvatarEditorFigureCategory.const_47,AvatarEditorFigureCategory.const_203,AvatarEditorFigureCategory.const_600,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_95];
         super();
         var_29 = param1;
         ...
         if(var_1400 == null)
         {
            _loc6_ = var_29.assets.getAssetByName("AvatarEditorThumb") as XmlAsset;
            var_1400 = var_29.windowManager.buildFromXML(_loc6_.content as XML) as IWindowContainer;
         }
         if(var_1627 == null)
         {
            _loc7_ = var_29.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1627 = var_29.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
      ...
      public function update() : void
      {
         ...
         if(var_29.sessionData.hasUserRight("fuse_use_wardrobe") && (var_1434 == AvatarEditorSideCategory.const_95 || var_1709))
         {
            _loc4_ = "null";
         }
      ...
      private function createWindow() : void
      {
         ...
         while(_loc1_ >= 0)
         {
            _loc2_ = var_468.getSelectableAt(_loc1_);
            if(_loc2_ != null && var_988.indexOf(_loc2_.name) < 0)
            {
               _loc3_ = var_468.removeSelectable(_loc2_);
               _loc4_ = _loc1_ + 1;
               while(_loc4_ < var_468.numSelectables)
               {
                  var_468.getSelectableAt(_loc4_).x = var_468.getSelectableAt(_loc4_).x - _loc3_.width;
                  _loc4_++;
               }
            }
            _loc1_--;
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return validateAvailableCategories(var_1072);
         }
         if(param1.length != var_988.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(var_988.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_522:
               break;
            case AvatarEditorSideCategory.const_389:
               _loc3_ = var_29.getSideContentWindowContainer(AvatarEditorSideCategory.const_389);
               break;
            case AvatarEditorSideCategory.const_95:
               _loc3_ = var_29.getSideContentWindowContainer(AvatarEditorSideCategory.const_95);
         }
         _loc2_.removeChildAt(0);
         _loc2_.invalidate();
         if(_loc3_)
      ...
      {
         if(var_1434 == AvatarEditorSideCategory.const_95)
         {
            var_1709 = false;
         ...
         {
            setSideContent(AvatarEditorSideCategory.const_95);
         }
      }
