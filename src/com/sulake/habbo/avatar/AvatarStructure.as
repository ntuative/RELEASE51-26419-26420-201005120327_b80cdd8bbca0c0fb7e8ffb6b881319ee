package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1614:PartOffsetData;
      
      private var var_953:AvatarActionManager;
      
      private var var_183:IAssetLibrary;
      
      private var var_952:IAssetLibrary;
      
      private var var_2267:AvatarRenderManager;
      
      private var var_329:FigureData;
      ...
      private var var_1613:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_183 = param2;
         var_952 = param3;
         var_329 = new FigureData();
         var_456 = new PartSetsData();
         _animationData = new AnimationData();
         var_1613 = new AvatarStructureDownloadSet();
         var_777 = new AnimationManager();
         var_778 = param4;
         var_1614 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_953.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_953.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_329.injectXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_953.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_777.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_456.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_456.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1367[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_953.getDefaultActionType();
         var _loc9_:Array = var_456.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_777.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_329.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_329.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        if(_loc14_.indexOf(_loc28_.type) > -1)
                        {
                           ...
                           _loc13_ = var_456.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_456.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_778 + " ready to go!");
         if(var_778 == AvatarType.const_82)
         {
            var_456.getPartDefinition("ri").appendToFigure = true;
            var_456.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_778)
         {
            case AvatarType.const_82:
               ...
               var_1613.add(new AvatarStructureDownload(var_183,_loc5_,var_329));
               break;
            case AvatarType.PET:
         }
         var_1613.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_777.getAnimation(param1);
      }
      ...
      {
         var_953 = new AvatarActionManager(var_183,var_778);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1389 = var_329.getMandatorySetTypeIds();
         return var_1389;
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_329.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_952.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_952.getAssetByName("dance" + _loc1_).content as XML;
            var_777.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_952.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_952.getAssetByName("fx" + _loc1_).content as XML;
            var_777.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_329.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_329.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         var_1614.loadOffsets(var_952);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_953.sortActions(param1);
      }
   }
}
