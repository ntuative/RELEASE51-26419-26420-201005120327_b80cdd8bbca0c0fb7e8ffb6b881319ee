package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_927:AvatarEditorHandler;
      ...
      private var var_587:String = "M";
      
      private var var_1592:Boolean;
      
      private var var_1111:IHabboAvatarEditorDataSaver = null;
      ...
      private function init() : void
      {
         ...
         if(!var_166)
         {
            ...
            _loc1_ = var_545["null"];
            _loc2_ = var_545["null"];
            _loc1_.loadAvatarData("hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007",FigureData.const_78);
            _loc2_.loadAvatarData("hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68",FigureData.const_71);
            var_89 = new Map();
            var_444 = new Map();
            var_89.add(AvatarEditorFigureCategory.const_560,new BodyModel(this));
            var_89.add(AvatarEditorFigureCategory.const_47,new HeadModel(this));
            var_89.add(AvatarEditorFigureCategory.const_203,new TorsoModel(this));
            var_89.add(AvatarEditorFigureCategory.const_600,new LegsModel(this));
            var_89.add(AvatarEditorFigureCategory.HOTLOOKS,new HotLooksModel(this));
            var_444.add(AvatarEditorSideCategory.const_95,new WardrobeModel(this));
            var_444.add(AvatarEditorSideCategory.const_389,new ClubPromoModel(this));
            var_166 = true;
         }
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(var_1111 != null)
         {
            ...
            _loc2_ = "null";
            var_1111.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_1112 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc13_ = isClubTryoutAllowed() && var_1592;
            for each(_loc14_ in _loc10_.colors)
            {
               if(_loc14_.isSelectable && (_loc13_ || var_1112 >= _loc14_.clubLevel))
               {
                  _loc16_ = 0;
                  while(_loc16_ < const_1144)
                  {
                     _loc17_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1627.clone() as IWindowContainer,param1,_loc14_);
            ...
            {
               _loc21_ = false;
               if(_loc6_.gender == FigureData.const_1241)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc21_ && (_loc13_ || var_1112 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1400.clone() as IWindowContainer,param1,_loc6_,_loc12_,_loc15_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_444.getValue(AvatarEditorSideCategory.const_95);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_927 = new AvatarEditorHandler(this,_communication);
      }
      ...
      {
         var _loc2_:ISideContentModel = var_444.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null) : Boolean
      {
         if(!var_166)
         {
            init();
         ...
         if(_view == null)
         {
            _view = new AvatarEditorView(this,_windowManager,_catalog,param3);
         }
         if(param1 != null)
         {
         ...
         else
         {
            if(_windowContext == null)
            {
               _windowContext = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_59,HabboWindowStyle.const_43,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         {
            toggleAvatarEditorPage(AvatarEditorFigureCategory.const_560);
         }
         var_1111 = param2;
         return true;
      }
      ...
      {
         var_764 = var_589.getFigureData(AvatarType.const_82);
      }
