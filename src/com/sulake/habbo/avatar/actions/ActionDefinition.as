package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1964 = parseInt(param1.@precedence);
         var_1959 = String(param1.@activepartset);
         var_1958 = String(param1.@assetpartdefinition);
         var_1963 = String(param1.@lay);
         var_1192 = String(param1.@geometrytype);
         var_1927 = Boolean(parseInt(param1.@main));
         var_1962 = Boolean(parseInt(param1.@method_13));
         var_1960 = Boolean(parseInt(param1.@animation));
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(var_593.getValue(param1) == null)
         {
            var_593.add(param1,new Map());
         }
         var _loc4_:Map = var_593.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = var_593.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
