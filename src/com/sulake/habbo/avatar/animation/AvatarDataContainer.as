package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1501,var_1499,var_1503,_alphaMultiplier);
         var_993 = generatePaletteMapForGrayscale(var_1730,var_1728);
      }
      
      public function get reds() : Array
      {
         return var_993.getValue("reds") as Array;
      }
      ...
      {
         return var_993.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_993.getValue("greens") as Array;
      }
      ...
      {
         return var_993.getValue("alphas") as Array;
      }
