package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private var var_839:IAvatarImage;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_622)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_442)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_53.getParts(param1,(var_839 as AvatarImage).getFigure(),_loc6_,var_1192,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_53.getCanvas(var_186,var_1192);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc23_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1327[param1])
            {
            ...
            else
            {
               ...
               if((_loc29_ == AvatarAction.const_857 || _loc29_ == AvatarAction.const_688) && (_loc6_ == AvatarBodyPartType.const_203 || _loc6_ == AvatarBodyPartType.const_1242 || _loc6_ == AvatarBodyPartType.const_1267) && _loc7_.color != null)
               {
         ...
         if(_loc17_)
         {
            if(var_186 == AvatarScaleType.const_56)
            {
               _loc25_.x += 67;
            }
            else
