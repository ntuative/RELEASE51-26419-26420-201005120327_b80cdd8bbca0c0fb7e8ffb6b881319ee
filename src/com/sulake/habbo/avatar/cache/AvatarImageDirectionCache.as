package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageDirectionCache
   {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:String = method_4(param2);
         if(false)
         {
      ...
      {
         var _loc2_:String = method_4(param1);
      ...
      public function comparePartList(param1:Array) : Boolean
      {
         ...
         if(var_723.length == param1.length)
         {
            _loc3_ = 0;
            while(_loc3_ < var_723.length)
            {
               _loc4_ = var_723[_loc3_];
               _loc5_ = var_723[_loc3_];
               if(_loc4_ != _loc5_)
               {
                  _loc2_ = false;
                  break;
