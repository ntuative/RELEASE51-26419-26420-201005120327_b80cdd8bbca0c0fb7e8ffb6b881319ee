package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_674:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_675.width,var_675.height,true,0);
            _loc1_.bitmap.copyPixels(var_675,var_675.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_805.width,var_805.height,true,0);
            _loc5_ = var_805.clone();
            _loc5_.colorTransform(_loc5_.rect,var_674.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_676.width,var_676.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_676,var_676.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(var_674)
            {
               switch(var_674.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_53:
                     _loc4_.style = HabboIconType.const_617;
                     _loc4_.visible = true;
               }
            }
            else
