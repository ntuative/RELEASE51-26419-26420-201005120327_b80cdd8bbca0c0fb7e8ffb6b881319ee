package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridView
   {
      ...
      private var var_466:IItemGridWindow;
      ...
      public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
      {
         ...
         if(_view != null)
         {
            var_466 = _view.findChildByName("part_thumbs") as IItemGridWindow;
            var_389 = new Array();
         ...
         if(param1.type == WindowMouseEvent.const_55)
         {
            ...
            while(_loc7_ < const_1144)
            {
               if(var_389.length > _loc7_)
               {
                  ...
                  if(_loc5_ > -1)
                  {
                     _model.selectColor(var_1148,_loc5_,_loc7_);
                     return;
                  }
               }
               _loc7_++;
      ...
      public function initFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:CategoryData = _model.getCategoryData(var_1148);
         if(!_loc1_)
         {
            return;
         }
         var_466.removeGridItems();
         for each(_loc2_ in _loc1_.parts)
         {
            if(_loc2_)
            {
               var_466.addGridItem(_loc2_.view);
      ...
      {
         var _loc3_:IWindow = var_466.getGridItemAt(param1);
         if(!_loc3_)
         {
            return;
         }
      ...
      private function partEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_55)
         {
            _loc3_ = var_466.getGridItemIndex(param1.window);
            _model.selectPart(var_1148,_loc3_);
         }
      }
