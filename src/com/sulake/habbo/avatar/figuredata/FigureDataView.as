package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_376:IBitmapWrapperWindow;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            var_1027 = _loc4_.content as BitmapData;
         }
         if(_window != null)
         {
            var_376 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      public function udpate(param1:BitmapData) : void
      {
         if(var_376 && var_1027)
         {
            var_376.bitmap = new BitmapData(var_376.width,var_376.height,true,16777215);
            var_376.bitmap.copyPixels(var_1027,var_1027.rect,new Point(0,0 - 0 - 8));
            var_376.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
   }
}
