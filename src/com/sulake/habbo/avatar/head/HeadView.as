   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_37)
         {
            ...
            var_37["null"] = new AvatarEditorGridView(_model,FigureData.const_145,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(_model,FigureData.const_190,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(_model,FigureData.const_177,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(_model,FigureData.const_180,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(_model,FigureData.const_163,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "tab_hair":
                  ...
                  break;
               case "tab_hat":
                  switchCategory(FigureData.const_190);
                  break;
