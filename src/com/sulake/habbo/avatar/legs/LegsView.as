   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_37)
         {
            ...
            var_37["null"] = new AvatarEditorGridView(_model,FigureData.const_176,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(_model,FigureData.const_179,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(_model,FigureData.const_164,_windowManager,_assetLibrary);
         }
         else
         {
