   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_37)
         {
            ...
            var_37["null"] = new AvatarEditorGridView(_model,FigureData.const_170,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(_model,FigureData.SHIRT,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(_model,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
         }
         else
         {
