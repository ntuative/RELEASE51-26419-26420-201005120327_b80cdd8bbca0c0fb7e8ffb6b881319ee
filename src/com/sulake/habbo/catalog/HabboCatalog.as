package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_441:ClubBuyController;
      ...
      private var var_210:PurchaseConfirmationDialog;
      ...
      private var var_442:ICatalogNavigator;
      ...
      private var var_2183:GiftWrappingConfiguration;
      ...
      private var var_1102:ClubGiftController;
      ...
      {
         return var_349.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_101.credits = _loc3_.balance;
         updatePurse();
         if(!var_2184 && var_542 != null)
         {
            var_542.playSound(HabboSoundTypesEnum.const_948);
         }
         var_2184 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_349.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_84)
         {
            _loc3_ = var_349.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function createClubBuyController() : void
      {
         if(var_441 == null)
         {
            var_441 = new ClubBuyController(this);
         }
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         {
            this.var_210.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_96:
               var_1352 = param1.session.isPrivateRoom;
               if(var_88 != null)
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_2183 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!var_918)
         {
            if(!var_349.loadProductData(this))
            {
               return;
            }
            init();
         ...
         if(var_204 != null && _loc2_)
         {
            var_204.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_1102.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_442 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_101.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_101.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         var_101.isVIP = _loc2_.isVIP;
         var_101.pastClubDays = _loc2_.pastClubDays;
         var_101.pastVipDays = _loc2_.pastVipDays;
         updatePurse();
      ...
      private function createClubGiftController() : void
      {
         if(var_1102 == null)
         {
            var_1102 = new ClubGiftController(this);
         }
      }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else if(param1 is Offer)
         {
            if(var_210 == null)
            {
               var_210 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_210.showOffer(this,param1,param2,param3,_loc7_);
         ...
         {
            var_441.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      {
         var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_131,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_442.buildCatalogIndex(_loc2_);
         if(var_1101 != "")
         {
            var_442.openPage(var_1101);
            var_1101 = "";
         }
         else
         {
            var_442.openFrontPage();
         }
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_101.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_101.pixels));
         var _loc1_:int = 0;
         if(true)
         {
         ...
         else
         {
            ...
            _localization.registerParameter(_loc2_,"days",String(var_101.clubDays));
            _localization.registerParameter(_loc2_,"months",String(var_101.clubPeriods));
         }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_101.pixels = _loc2_.amount;
         updatePurse();
         if(!var_2182 && var_542 != null)
         {
            var_542.playSound(HabboSoundTypesEnum.const_1029);
         }
         var_2182 = false;
      }
