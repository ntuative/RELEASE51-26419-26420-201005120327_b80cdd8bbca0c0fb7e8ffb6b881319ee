package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1734:int = 3;
      
      public const const_1645:int = 2;
      ...
      private var var_1805:MarketplaceItemStats;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1604,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_1799 || param1.furniTypeId != var_1803)
         {
            return;
         }
         var_1805 = param1;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1645,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc3_.status == MarketPlaceOfferState.const_458)
            {
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1743 = _loc3_.creditsWaiting;
         var_197 = new Map();
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_210)
         {
            var_210 = new MarketplaceConfirmationDialog(this,_catalog,_roomEngine);
         }
         var_210.showConfirmation(param1,param2);
      }
      ...
      {
         requestOffers(var_1802,var_1806,var_1804,var_1800);
      }
