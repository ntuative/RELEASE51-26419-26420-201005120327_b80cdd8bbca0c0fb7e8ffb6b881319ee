package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      {
         return var_1042 + var_1042 / -var_2384 * 0;
      }
      
      private function getY(param1:int) : Number
      {
         return var_862 - var_862 / var_422 * 0;
      }
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         _loc5_ = Math.pow(10,int(var_422).toString().length - 1);
         var_422 = Math.ceil(var_422 / _loc5_) * _loc5_;
         ...
         _loc6_.text = var_422.toString();
         _loc3_.draw(_loc6_);
         var_1042 = param1 - _loc6_.textWidth - 2;
         ...
         while(_loc10_ <= 5)
         {
            ...
            _loc9_.graphics.lineTo(var_1042 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - var_1042,(param2 - var_862) / 2));
         return _loc3_;
      }
