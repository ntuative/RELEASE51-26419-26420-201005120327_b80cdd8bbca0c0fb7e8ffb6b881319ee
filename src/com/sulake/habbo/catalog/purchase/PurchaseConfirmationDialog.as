package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1461:uint = 4.294967295E9;
      
      private const const_1462:uint = 4.293848814E9;
      
      private var var_832:int;
      
      private const const_1703:uint = 4.291613146E9;
      
      private var var_256:int = -1;
      ...
      private const const_1702:int = 10;
      ...
      private function checkboxHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_747:
               showSelectors(false);
               break;
            case WindowEvent.const_699:
               showSelectors(true);
         }
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_831;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_831,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1462) : uint(const_1461);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_399,var_77,var_1024);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_256) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function method_11() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_831);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_584[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_585[var_200]);
         _catalog.purchaseProductAsGift(var_399,var_77,var_1024,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_135:
               ...
               if(var_1838 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in var_241)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= const_1702)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_1838 = _loc3_.text;
               break;
            case WindowMouseEvent.const_55:
               showSuggestions(false);
               if(var_1223)
               ...
               break;
            case WindowKeyboardEvent.const_710:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     highlightSuggestion(var_256 - 1);
                     break;
                  case Keyboard.DOWN:
                     highlightSuggestion(var_256 + 1);
                     break;
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_84:
                  ...
                  break;
               case ProductTypeEnum.const_213:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1430 = _loc1_.stuffTypes;
            var_584 = _loc1_.boxTypes;
            var_585 = _loc1_.ribbonTypes;
            var_831 = var_1430[0];
            _boxIndex = var_584[0];
            var_200 = var_585[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(var_256) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_256);
         }
         var_256 = param1;
         if(var_256 < 0)
         {
            var_256 = _loc2_.numListItems - 1;
         }
         if(var_256 >= _loc2_.numListItems)
         {
            var_256 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_256) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_493 == null)
         {
            var_493 = createWindow("suggestion_list_item") as IWindowContainer;
            var_493.procedure = suggestionsEventHandler;
         }
         if(var_225 == null || var_493 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_225.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_493.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
