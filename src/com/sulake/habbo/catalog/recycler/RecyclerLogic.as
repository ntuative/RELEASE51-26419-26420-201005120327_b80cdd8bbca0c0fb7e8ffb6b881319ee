package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1510)
         {
            case RecyclerStatusMessageEvent.const_1213:
               ...
               break;
            case RecyclerStatusMessageEvent.const_980:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1510 != RecyclerStatusMessageEvent.const_980;
      }
      
      private function get statusActive() : Boolean
      {
         return var_264 != const_793;
      }
      ...
      {
         return active && var_264 == const_364;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_910:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1255:
