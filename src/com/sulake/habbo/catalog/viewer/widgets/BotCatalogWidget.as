package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_926:Offer;
      
      public function BotCatalogWidget(param1:IWindowContainer)
      {
         super(param1);
         var_969 = _window.findChildByName("botGrid") as IItemGridWindow;
      }
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         var _loc3_:String = var_1583.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
         ...
         if(_loc5_)
         {
            ...
            _loc6_ = _loc5_.getImage(AvatarSetType.const_41,true);
      ...
      {
         var _loc1_:String = var_1583.getValue(var_926.productContainer.firstProduct.extraParam.toLowerCase());
         ...
         if(_loc2_)
         {
            _loc2_.setDirection(AvatarSetType.const_41,4);
            setPreviewImage(_loc2_.getImage(AvatarSetType.const_41,true));
            _loc2_.dispose();
         }
      }
      ...
      {
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_926,page);
      }
      ...
      private function setProductData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","credits",String(var_926.priceInCredits));
            _loc1_.registerParameter("catalog.purchase.price.credits+pixels","pixels",String(var_926.priceInPixels));
            _loc2_.text = "${catalog.purchase.price.credits+pixels}";
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(var_926.localizationId);
