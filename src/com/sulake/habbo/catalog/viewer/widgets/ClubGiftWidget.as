package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private const const_157:int = 31;
      ...
      private function updateList() : void
      {
         ...
         for each(_loc6_ in _loc2_)
         {
            ...
            if(_loc5_)
            {
               ...
               var_569.add(_loc1_.offerId,_loc1_);
            }
         }
      }
      ...
      private function updateInfo() : void
      {
         ...
         if(_loc5_)
         {
            _loc2_ = var_29.purse.pastClubDays > const_157 ? "catalog.club_gift.past_club.long" : "catalog.club_gift.past_club";
            _loc3_ = var_29.purse.pastClubDays % const_157;
            _loc4_ = var_29.purse.pastClubDays / const_157;
         ...
         if(_loc6_)
         {
            _loc2_ = var_29.purse.pastVipDays > const_157 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = var_29.purse.pastVipDays % const_157;
            _loc4_ = var_29.purse.pastVipDays / const_157;
            var_29.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            var_29.localization.registerParameter(_loc2_,"months",_loc4_.toString());
      ...
      {
         if(!param1 || !param2 || !var_569 || !var_29)
         {
            return;
         }
         ...
         var _loc3_:Offer = var_569.getValue(param2.id) as Offer;
         if(!_loc3_)
         {
            return;
         }
      ...
      private function createListItem(param1:Offer, param2:ClubGiftData) : IWindow
      {
         ...
         {
            _loc11_ = param2.monthsRequired * const_157;
            if(param2.isVip)
            {
            ...
            {
               _loc13_ = _loc12_ % const_157;
               _loc14_ = _loc12_ / const_157;
