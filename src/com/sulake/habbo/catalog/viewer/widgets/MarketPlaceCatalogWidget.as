package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_807:MarketPlaceOfferData;
      
      private const const_1438:int = 1;
      
      private const const_1699:int = 40;
      
      private var var_473:IWindowContainer;
      
      private const const_1439:int = 2;
      ...
      private const const_1698:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_473)
         {
            ...
            var_473 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_473)
         {
            return;
         ...
         updateStatusDisplay(const_1439,_loc2_.length);
         if(!var_400)
         {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_569)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_473 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_473.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1438);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_808 >= var_569.length)
            {
               return true;
            }
            addListItem(var_569.getWithIndex(var_808));
            ++var_808;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_807.offerId);
            }
            return;
         }
