package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_592:IItemGridWindow;
      
      private var var_84:IBitmapWrapperWindow;
      
      private var var_1360:ITextWindow;
      
      private var var_1238:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_592 != null)
         {
            var_592.visible = false;
            var_592.destroyGridItems();
         }
         if(var_1238 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1360.text = "${" + _loc3_.name + "}";
            var_1361.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1360.text = "${" + _loc2_.localizationId + "}";
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_408:
                  _loc4_ = var_1237.clone();
                  if(var_592 != null)
                  {
                     var_592.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_592,var_1238,var_1269);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_213:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_321,AvatarAction.const_726);
                              _loc13_.appendAction(AvatarAction.const_578,_loc6_.productClassId);
                              _loc13_.endActionAppends();
                              _loc13_.updateAnimationByFrames(1);
                              _loc13_.updateAnimationByFrames(1);
                              _loc11_ = _loc13_.getImage(AvatarSetType.const_41,true);
      ...
      {
         var_1360 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1361 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_84 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1472 = new Point(var_84.x,var_84.y);
         var_592 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1238 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_592 == null)
         {
         ...
         var_1237 = _loc2_.content as BitmapData;
      ...
      private function retrievePreviewAsset(param1:String) : void
      {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.const_35,onPreviewImageReady);
      }
