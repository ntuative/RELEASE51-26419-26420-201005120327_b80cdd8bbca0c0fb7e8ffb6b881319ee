package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1313:String = "default";
      ...
      private var var_1314:String = "1.1";
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_277 != null && var_278 != null)
         {
            setRoomImage(var_277,var_278);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_161.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(var_242 >= 0)
               {
                  _loc9_ = _loc1_.children()[var_242];
                  if(_loc9_ != null)
                  {
                     var_1313 = _loc9_.@id;
                  }
         ...
         switch(param1)
         {
            case const_198:
               ...
               for each(_loc8_ in var_161.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_756 = _loc8_.children().length();
                  }
               }
            ...
            case const_197:
               ...
               if(var_319 >= _activeFloorPatterns.length)
               {
                  var_319 = 0;
               }
               var_275 = 0;
               ...
               for each(_loc9_ in var_161.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_757 = _loc9_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1313);
               }
               break;
            ...
            case "ctlg_landscape_pattern_next":
               changePattern(const_199,-1);
               break;
            case "ctlg_landscape_pattern_prev":
               changePattern(const_199,1);
               break;
            case "ctlg_landscape_color_prev":
               changeColor(const_199,-1);
               break;
            case "ctlg_landscape_color_next":
               changeColor(const_199,1);
               break;
            case "ctlg_buy_landscape":
               _loc3_ = var_1342[var_317];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1314);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1313,var_1314,64,this,"window_romantic_wide");
