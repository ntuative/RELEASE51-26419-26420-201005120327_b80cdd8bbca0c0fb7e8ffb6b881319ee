package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1815:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1455:ILogger;
      
      private var var_1194:String;
      
      private var var_1814:String;
      
      private const const_1437:String = "fuselogin";
      
      private var var_308:ICoreCommunicationManager;
      
      private var var_410:IKeyExchange;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1813)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_685 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_685);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1194,var_1814));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1437,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_410.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_410.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1815);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1437,"/");
      ...
      {
         var_685 = _habboConfiguration.getKey("sso.ticket",null);
         var_1194 = _habboConfiguration.getKey("flash.client.url","");
         var_1814 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_169 == null)
         {
         ...
         if(var_685 != null)
         {
            var_59.mode = HabboConnectionType.const_462;
            var_59.initConnection(HabboConnectionType.const_265);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1455 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_697);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1815 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_59.mode)
         {
            case HabboConnectionType.const_462:
               _loc6_ = "";
               ...
               var_1008 = _loc4_;
               var_169.loadBannerImage(_loc7_ + "?token=" + var_1008,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_934:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1304:
               var_577 = generateRandomHexString(30);
               var_410 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_410.init(var_577);
               _loc8_ = var_410.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1008);
         ...
         var_410 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_410.init(_loc14_);
            _loc15_ = var_410.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_59.mode = HabboConnectionType.const_934;
            }
         }
         var_59.initConnection(HabboConnectionType.const_265);
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_227);
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_110,onRoomSessionEnded);
      }
