package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_641:Function;
      
      private var _window:IWindowContainer;
      
      private var var_765:IAssetLibrary;
      
      private var var_928:uint = 0;
      
      private var var_642:Function;
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = var_765.getAssetByName(_loc2_.assetName);
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_49,hotelViewLoadedCallbackHandler);
      }
      
      public function loadBannerImage(param1:String, param2:Function) : void
      {
         var _loc3_:AssetLoaderStruct = var_765.loadAssetFromFile("hotel_view_banner_" + var_928,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
            _loc3_.addEventListener(AssetLoaderEvent.const_35,bannerLoadedHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_49,bannerLoadedHandler);
         }
         else
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_624));
            }
            var_642 = param2;
            _loc3_.addEventListener(AssetLoaderEvent.const_35,bannerLoadedCallbackHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_49,bannerLoadedCallbackHandler);
         }
         ++var_928;
      }
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_49,hotelViewLoadedHandler);
      }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_765.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
            _loc3_.addEventListener(AssetLoaderEvent.const_35,hotelViewLoadedHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_49,hotelViewLoadedHandler);
         }
         else
         {
            var_641 = param2;
            _loc3_.addEventListener(AssetLoaderEvent.const_35,hotelViewLoadedCallbackHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_49,hotelViewLoadedCallbackHandler);
         }
         ++var_928;
      }
      ...
      private function bannerLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_49,bannerLoadedCallbackHandler);
      }
      ...
      private function bannerLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_49,bannerLoadedHandler);
      }
