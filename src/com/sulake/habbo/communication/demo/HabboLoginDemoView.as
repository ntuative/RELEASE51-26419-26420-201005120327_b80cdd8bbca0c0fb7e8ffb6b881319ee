package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_604:String = "InitConnection";
      ...
      private var var_222:HabboCommunicationDemo;
      ...
      {
         var_222.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_222.shockwaveClientUrl = var_111.shockwaveClientUrl;
         var_222.ssoTicket = var_111.ticket;
         var_111.removeEventListener(SSOTicket.const_323,onParsedTicketSuccess);
         var_111.removeEventListener(SSOTicket.const_270,onParsedTicketFailure);
         var_111 = null;
         dispatchEvent(new Event(const_604));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1437,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_222 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_222.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_402,HabboWindowStyle.const_40,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_222.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1437,"/");
         if(_loc5_ != null)
         {
      ...
      private function listEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_222.sendTryLogin(name,password,param2.id);
      }
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_222.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_222.habboCommunication.habboWebLogin(name,password);
         var_111 = new SSOTicket(var_222.assets,_loc2_,_loc1_);
         var_111.addEventListener(SSOTicket.const_323,onParsedTicketSuccess);
         var_111.addEventListener(SSOTicket.const_270,onParsedTicketFailure);
      }
      ...
      public function populateUserList(param1:Map) : void
      {
         ...
         var _loc3_:XmlAsset = var_222.assets.getAssetByName("login_user_list_item") as XmlAsset;
         var _loc4_:IWindow = var_222.windowManager.buildFromXML(_loc3_.content as XML);
