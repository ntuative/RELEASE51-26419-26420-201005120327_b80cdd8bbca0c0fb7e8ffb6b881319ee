package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1306:uint = 1;
      
      public static const const_1310:uint = 2;
       
      
      private var var_950:IProtocolDecoder;
      
      private var var_1122:IProtocolEncoder;
      
      public function WedgieProtocol()
      {
         super();
         var_1122 = new WedgieEncoder();
         var_950 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1306)
            {
               _loc4_.position = 0;
               _loc6_ = var_950.getID(_loc4_);
