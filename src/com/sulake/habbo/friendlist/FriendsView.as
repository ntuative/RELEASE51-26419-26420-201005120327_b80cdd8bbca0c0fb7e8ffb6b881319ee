package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_717:String = "bg";
       
      
      private var var_1712:IContainerButtonWindow;
      
      private var var_1711:IContainerButtonWindow;
      ...
      {
         _friendList = param1;
         var_357 = new AvatarPopupCtrl(_friendList);
      }
      ...
      {
         var_1711 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1714 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1712 = initButton("room_invite",onInviteButtonClick,param1);
         var_1713 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc3_.id = param2.id;
         var _loc4_:IWindow = _loc3_.findChildByName(const_717);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_357.showPopup(_friendList.view.mainWindow,_loc3_.view);
         }
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1711,isEnableMinimailButton(_loc1_));
         setEnabled(var_1714,isEnableHomeButton(_loc1_));
         setEnabled(var_1712,isEnableInviteButton(_loc1_));
         setEnabled(var_1713,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_717);
