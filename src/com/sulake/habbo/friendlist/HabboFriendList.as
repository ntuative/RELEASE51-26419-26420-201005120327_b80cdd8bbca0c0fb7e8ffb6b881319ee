package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_2121:FriendListLookAndFeel;
      ...
      {
         var_2121 = new FriendListLookAndFeel();
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_89.addCategory(new FriendCategory(FriendCategory.const_986,getText("friendlist.friends")));
         var_89.addCategory(new FriendCategory(FriendCategory.const_440,getText("friendlist.friends.offlinecaption")));
         ...
         if(!var_529)
         {
            var_529 = new Timer(120000);
            var_529.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_529.start();
         }
         getBuddyRequests();
         registerListeners();
         var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_131,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_529.stop();
            var_529.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_529 = null;
         }
         if(_windowManager)
         {
      ...
      private function toggleWindow() : void
      {
         ...
         else
         {
            ...
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_310));
            }
            else
            {
               switch(_loc1_.id)
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_172,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_367.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_204.events.dispatchEvent(_loc1_);
      }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_616.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_616.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
