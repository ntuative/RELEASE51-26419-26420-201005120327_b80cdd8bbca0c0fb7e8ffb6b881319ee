package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_694:ITextFieldWindow;
      ...
      {
         var_694 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_694.procedure = onSearchInput;
         var_694.addEventListener(WindowKeyboardEvent.const_147,onSearchStrInput);
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_357.showPopup(_friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_694.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
