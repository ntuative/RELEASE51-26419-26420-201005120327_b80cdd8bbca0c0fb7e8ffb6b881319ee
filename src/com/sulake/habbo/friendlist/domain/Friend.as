package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1600:int = "F".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         var_784 = param1.online;
         var_1151 = param1.followingAllowed && param1.online;
         var_302 = param1.figure;
         var_1153 = param1.motto;
         var_1152 = param1.lastAccess;
         var_1148 = param1.categoryId;
