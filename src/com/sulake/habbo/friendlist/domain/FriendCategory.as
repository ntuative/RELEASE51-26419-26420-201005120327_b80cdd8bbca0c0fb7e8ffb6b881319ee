package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_986:int = 0;
      
      public static const const_440:int = -1;
      
      public static const const_345:int = 100;
      ...
      {
         return Math.ceil(this.var_241.length / const_345);
      }
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         {
            _loc4_ = var_241[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               var_241.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_895 + 1) * const_345,this.var_241.length);
      }
