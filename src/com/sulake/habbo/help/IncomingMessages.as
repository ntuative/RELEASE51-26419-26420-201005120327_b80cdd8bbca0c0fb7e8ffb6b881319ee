package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboHelp, param2:IHabboCommunicationManager)
      {
         ...
         _loc3_.addHabboConnectionMessageEvent(new UsersMessageEvent(method_12));
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         while(_loc7_ < _loc4_.length)
         {
            ...
            _loc6_.method_8(_loc8_,_loc9_);
            _loc7_++;
         }
         var_23.tellUI(HabboHelpViewEnum.const_287,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         while(_loc7_ < _loc4_.length)
         {
            _loc6_.method_8(_loc4_.getKey(_loc7_),_loc4_.getWithIndex(_loc7_));
            _loc7_++;
         }
         ...
         {
            _loc6_.method_8(_loc5_.getKey(_loc7_),_loc5_.getWithIndex(_loc7_));
            _loc7_++;
         }
         var_23.tellUI(HabboHelpViewEnum.const_151);
      }
      ...
      {
         var_23.showUI(HabboHelpViewEnum.const_313);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_23.showUI(HabboHelpViewEnum.const_488);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         {
            _loc5_.method_8(_loc4_.getKey(_loc6_),_loc4_.getWithIndex(_loc6_));
            _loc6_++;
         }
         var_23.showUI(HabboHelpViewEnum.const_539);
         var_23.tellUI(HabboHelpViewEnum.const_539,_loc5_);
      }
      ...
      private function method_12(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_302)
            {
         ...
         var_23.tellUI(HabboHelpViewEnum.const_591);
      }
