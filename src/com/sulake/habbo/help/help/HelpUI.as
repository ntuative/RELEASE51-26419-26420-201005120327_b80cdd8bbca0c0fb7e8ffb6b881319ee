package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1458:int = 0;
      ...
      private var var_2135:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","26419-26420-201005120242");
         var_204 = param5;
         var_108 = new Map();
         var_108.add(HabboHelpViewEnum.const_1354,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_151,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_488,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_287,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_237,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_539,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_313,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_579,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_207,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_108.add(HabboHelpViewEnum.const_952,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_591,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_271 == HabboHelpViewEnum.const_151 || false)
         {
            return;
         }
         if(var_431 == null)
         {
            ...
            var_431 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_431 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_431 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_431 as IWindow);
      ...
      {
         return var_108.getValue(var_271);
      }
      ...
      {
         var_2136 = param1;
         var _loc2_:IHelpViewController = var_108.getValue(HabboHelpViewEnum.const_151) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_992:
               showUI(HabboHelpViewEnum.const_952);
               break;
      ...
      {
         var _loc3_:* = null;
         if(var_271 == HabboHelpViewEnum.const_151)
         {
            return;
         }
         if(true)
         {
            ...
            var_620.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_620.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_431.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_620[1],var_620[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_620[0],var_620[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1559;
         _window.width = _loc1_.width + var_1560;
      }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_410));
      }
