package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_665:FaqCategory;
      
      private var var_666:FaqCategory;
      ...
      {
         super();
         var_666 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_665 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_123 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_666.hasItem(param1))
         {
            var_666.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_665.hasItem(param1))
         {
            var_665.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
