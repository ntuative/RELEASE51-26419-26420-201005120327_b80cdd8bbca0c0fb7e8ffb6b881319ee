package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private static var var_1438:uint = 13232628;
      
      private static var var_1727:uint = 11129827;
      ...
      private var var_797:NameSuggestionListRenderer;
      ...
      private var var_1357:IWindowContainer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         var_29.localization.registerParameter("help.tutorial.name.available","name",var_373);
      ...
      private function showSelectionView() : void
      {
         if(!var_633)
         {
            var_633 = createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!var_633)
            {
               return;
            }
            _window.content.addChild(var_633);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!var_250)
         {
            var_250 = createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!var_250)
            {
               return;
            }
            _window.content.addChild(var_250);
         }
         _window.caption = var_29.localization.getKey("hotel_merge.name_change.title.confirm");
         var _loc1_:ITextWindow = var_250.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = var_373;
         }
      ...
      public function showMainView() : void
      {
         if(!_window)
         {
            ...
            var_1357 = _window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1126 || param1 == ChangeUserNameResultMessageEvent.var_1125)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         var_797 = new NameSuggestionListRenderer(var_29);
         var _loc6_:int = var_797.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1438;
