package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_823:IRoomSession;
      ...
      private const const_1700:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            var_18.events.removeEventListener(RoomSessionEvent.const_96,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionEvent.const_110,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_477,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_110:
               var_823 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_477:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_46.getValue(InventoryCategory.const_523));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_46.getValue(InventoryCategory.const_81));
      }
      ...
      {
         return PetsModel(var_46.getValue(InventoryCategory.const_153));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_865));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1700);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_46.getValue(InventoryCategory.const_337));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_258:
               _view.toggleCategoryView(InventoryCategory.const_81,false);
         }
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_822.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_822.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_46.getValue(InventorySubCategory.const_258));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_349 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_822.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_46.getValue(InventoryCategory.const_308) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1013 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_46.getValue(InventoryCategory.const_283));
      }
      ...
      {
         return _view.method_10();
      }
      
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_18 = IRoomSessionManager(param2);
         var_18.events.addEventListener(RoomSessionEvent.const_96,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionEvent.const_110,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_477,roomSessionEventHandler);
         ...
         var_46.add(InventoryCategory.const_308,_loc3_);
         ...
         var_46.add(InventoryCategory.const_81,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_349);
         var_46.add(InventoryCategory.const_283,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_46.add(InventoryCategory.const_523,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_349);
         var_46.add(InventoryCategory.const_337,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_46.add(InventorySubCategory.const_258,_loc8_);
         ...
         var_46.add(InventoryCategory.const_153,_loc10_);
