package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1077:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_614 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_614.width;
         var_96 = var_614.height;
         var_1078 = param5;
         var_893 = param6;
         var_240 = Math.floor(var_1078 / _thumbWidth);
         var_19 = new BitmapData(var_1078,var_893);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(param1.y < var_527 - 1)
         {
            ...
            var_19.fillRect(new Rectangle(0,0 - var_96,var_19.width,var_96),4294967295);
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               _loc11_ = new BitmapData(var_19.width,0 - var_96);
               _loc2_ = new Rectangle(0,0,var_19.width,0 - var_96);
               _loc11_.copyPixels(var_19,_loc2_,new Point(0,0),null,null,true);
               var_19 = _loc11_;
               --var_527;
            }
         }
         if(var_19.height < var_893)
         {
            _loc12_ = new BitmapData(var_19.width,var_893);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_614.width,var_614.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_614.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_614,var_614.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_1077 != null)
         {
            _loc1_ = var_1077.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_527 = resolveRowCountFromList();
         if(var_527 == 0)
         {
            var_19 = new BitmapData(var_1078,var_893);
            return;
         }
         var_19 = new BitmapData(Math.max(var_240 * _thumbWidth,var_1078),Math.max(var_527 * var_96,var_893),true,16777215);
         var_19.fillRect(var_19.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_527)
         {
            _loc4_ = 0;
            while(_loc4_ < var_240)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     var_19.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * _thumbWidth,_loc3_ * var_96),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_240 && var_19.height < _loc3_.y * var_96)
         {
            _loc2_ = new BitmapData(var_19.width,var_19.height + var_96);
         }
         else
         {
         ...
         _loc2_.copyPixels(var_19,_loc4_,new Point(0,var_96),null,null,true);
         _loc4_ = new Rectangle(0,var_96,_thumbWidth * (var_240 - 1),0 - var_96);
         _loc2_.copyPixels(var_19,_loc4_,new Point(_thumbWidth,var_96),null,null,true);
         var_19 = _loc2_;
      }
