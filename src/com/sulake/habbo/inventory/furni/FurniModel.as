package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_512 = new Timer(const_1112,1);
         var_512.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return var_29.method_10() == InventorySubCategory.const_258;
      }
         ...
         while(_loc3_ < _loc2_.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_558)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_512 != null)
            {
               var_512.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_512.stop();
               var_512 = null;
            }
            if(var_133 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_319)
         {
      ...
      {
         var_29.checkCategoryInitilization(InventoryCategory.const_308);
         ...
         if(param1 == InventoryCategory.const_81 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_46:
                  ...
                  break;
               case const_327:
                  var_29.toggleInventoryPage(InventoryCategory.const_153);
            }
         }
      }
      ...
      {
         if(var_864 && param1.type == RoomEngineObjectEvent.const_221)
         {
            var_29.showView();
            var_864 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_311 || _loc3_.category == FurniCategory.const_306 || _loc3_.category == FurniCategory.const_319)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_424 = new Map();
         var_424.add(const_45,new Array());
         var_424.add(const_46,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
