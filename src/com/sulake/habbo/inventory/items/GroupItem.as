package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_1486:Number;
      
      protected var _type:int;
      
      protected var _roomEngine:IRoomEngine;
      
      protected var var_2311:BitmapData;
      
      protected var var_966:Boolean;
      
      protected var var_2310:Boolean;
      
      protected var var_1731:int;
      
      protected var _mainCategory:String;
      
      protected var var_462:int = 0;
      
      protected var var_1415:String;
      
      private const const_1711:int = 8947848;
      ...
      private const const_1451:Number = 0.2;
      
      protected var var_1408:Boolean;
      
      private const const_1452:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_558)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1486));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1415);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1451;
               _loc1_.blend = const_1451;
            }
            else
            {
               _window.blend = const_1452;
               _loc1_.blend = const_1452;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1408 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2311;
               _loc5_.visible = true;
            }
            else
            {
