package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1581,var_1582);
         }
      }
      ...
      {
         if(param1 != var_1799 || param2 != var_1803)
         {
            return;
         }
         if(!_view)
      ...
      {
         if(var_29 != null && false && var_223 != null)
         {
            var_29.furniModel.removeLockFrom(var_223.id);
            var_223 = null;
         }
      }
