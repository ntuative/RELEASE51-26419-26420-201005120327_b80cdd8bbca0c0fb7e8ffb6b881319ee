package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IAvatarImageListener
   {
      ...
      private var var_326:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_554 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_644 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_644.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_326 != null)
         {
            var_326.setSelected(false);
         }
         var_326 = param1;
         if(var_326 != null)
         {
            var_326.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_326.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_644.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_554.removeGridItem(_loc2_.window);
         if(var_326 == _loc2_)
         {
            var_326 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_644.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_554.addGridItem(_loc2_.window);
            var_644.add(param1.id,_loc2_);
            if(var_326 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         else
         {
            ...
            _loc13_.setDirection(AvatarSetType.const_41,4);
            _loc2_ = _loc13_.getCroppedImage(AvatarSetType.const_41);
            _loc3_ = _loc12_.name;
