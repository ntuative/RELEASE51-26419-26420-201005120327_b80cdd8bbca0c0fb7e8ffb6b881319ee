package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger
   {
      ...
      public static const const_166:String = "face";
       
      
      private var _friendList:IHabboFriendList;
      
      private var var_896:IAvatarRenderManager;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_204:IHabboToolbar;
      
      private var var_618:Conversations;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_315:MessengerView;
      ...
      {
         var _loc2_:Conversation = var_618.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            var_618.setSelected(_loc2_);
            var_315.openMessenger();
            var_315.refresh(true);
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IAvatarImage = var_896.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(_loc2_)
         {
      ...
      {
         var_618.addMessageAndUpdateView(param1);
         if(!var_315.isMessengerOpen())
         {
      ...
      {
         var_618 = new Conversations(new ConversationsDeps(this));
         var_315 = new MessengerView(this);
      ...
      override public function dispose() : void
      {
         ...
         if(var_896)
         {
            var_896.release(new IIDAvatarRenderManager());
            var_896 = null;
         }
         if(var_204)
         {
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_174,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_131,HabboToolbarIconEnum.MESSENGER));
         var _loc3_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_172,HabboToolbarIconEnum.MESSENGER);
      ...
      {
         var_618.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_896 = param2 as IAvatarRenderManager;
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_755,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         addMsg(_loc3_);
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         var_618.setFollowingAllowedAndUpdateView(param1,param2);
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_903,_loc2_.userId,getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         var_618.addMessageAndUpdateView(_loc3_);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_204 = IHabboToolbar(param2) as IHabboToolbar;
