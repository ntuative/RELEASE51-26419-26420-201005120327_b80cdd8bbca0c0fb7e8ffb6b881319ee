package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_889:ConversationsTabView;
      
      private var _disposed:Boolean = false;
      
      private var var_124:HabboMessenger;
      
      private var var_1311:ConversationView;
      ...
      private function onResizeTimer(param1:TimerEvent) : void
      {
         ...
         this.var_1311.afterResize();
         this.var_889.refresh();
      }
      ...
      private function sendMsg() : void
      {
         ...
         var_732.text = "";
         var_124.conversations.addMessageAndUpdateView(new Message(Message.const_704,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      ...
      public function openMessenger() : void
      {
         ...
         if(var_14 == null)
         {
            prepareContent();
            refresh(true);
            var_124.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.MESSENGER,var_14));
         }
         else
         {
            refresh(true);
      ...
      {
         return this.var_889 == null ? 7 : int(this.var_889.getTabCount());
      }
      ...
      {
         var_14 = IFrameWindow(var_124.getXmlWindow("main_window"));
         ...
         var_889 = new ConversationsTabView(var_124,var_14);
         var_889.refresh();
         var_732 = ITextFieldWindow(var_14.findChildByName("message_input"));
         var_732.addEventListener(WindowKeyboardEvent.const_147,onMessageInput);
         var_1311 = new ConversationView(var_124,var_14);
         var_14.scaler.setParamFlag(HabboWindowParam.const_735,false);
         var_14.scaler.setParamFlag(HabboWindowParam.const_821,true);
      }
   }
}
