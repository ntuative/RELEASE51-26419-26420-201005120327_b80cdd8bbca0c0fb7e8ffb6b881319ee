package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1572:IMessageComposer;
      ...
      {
         var_830 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_829 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         ...
         _main.connection.send(var_1572);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_830.clone());
      ...
      {
         if(param1.type != WindowEvent.const_48 || param2 != var_55)
         {
            return;
         }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_829.clone());
