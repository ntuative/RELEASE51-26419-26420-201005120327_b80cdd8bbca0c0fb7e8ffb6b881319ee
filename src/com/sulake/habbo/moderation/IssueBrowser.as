package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1704:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1706:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1473:IIssueBrowserView;
      
      private const const_1730:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1705:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_227:ITabContextWindow;
      
      private var var_1475:PickedIssuesView;
      
      private var var_350:IIssueBrowserView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_350.view.width = var_227.container.width;
         var_350.view.height = var_227.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1705:
               if(var_1473 == null)
               {
                  var_1473 = new MyIssuesView(issueManager,this,var_227.container);
               }
               return var_1473;
            case const_1704:
               if(var_1474 == null)
               {
                  var_1474 = new OpenIssuesView(issueManager,this,var_227.container);
               }
               return var_1474;
            case const_1706:
               if(var_1475 == null)
               {
                  var_1475 = new PickedIssuesView(issueManager,this,var_227.container);
               }
               return var_1475;
            default:
               return null;
