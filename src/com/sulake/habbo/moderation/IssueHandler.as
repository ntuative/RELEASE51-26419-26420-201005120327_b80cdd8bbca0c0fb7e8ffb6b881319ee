package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_1043:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var_423 = new UserInfoCtrl(_window,var_61,_loc3_.message);
         var_1043 = new UserInfoCtrl(_window,var_61,_loc3_.message);
         var_423.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_113.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1043.load(_loc4_,var_113.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_61.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_61,WindowTracker.const_1017,_loc2_),_window,false,false,true);
      }
