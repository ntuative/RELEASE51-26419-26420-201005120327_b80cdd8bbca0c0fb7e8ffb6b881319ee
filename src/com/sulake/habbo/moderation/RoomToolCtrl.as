package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_721:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_621,_data.flatId),var_55,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_412);
         if(param1.flatId != var_412)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_412);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_721.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1398,_loc2_,var_420.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1050.isSelected,var_1051.isSelected,var_721.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         ...
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1299);
      }
      ...
      public function populate() : void
      {
         ...
         var_721 = ICheckBoxWindow(var_55.findChildByName("kick_check"));
         var_1050 = ICheckBoxWindow(var_55.findChildByName("lock_check"));
         var_1051 = ICheckBoxWindow(var_55.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_412));
         Logger.log("BEGINNING TO SHOW: " + var_412);
      }
   }
}
