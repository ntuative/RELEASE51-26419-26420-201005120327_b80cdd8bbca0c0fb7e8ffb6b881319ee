package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_797:int = 31536000;
      
      private static const const_799:int = 86400;
      
      private static const const_798:int = 3600;
      
      private static const const_800:int = 60;
      ...
      {
         if(param1 < 2 * const_800)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_798)
         {
            return Math.round(param1 / const_800) + " mins ago";
         }
         if(param1 < 2 * const_799)
         {
            return Math.round(param1 / const_798) + " hours ago";
         }
         if(param1 < 2 * const_797)
         {
            return Math.round(param1 / const_799) + " days ago";
         }
         return Math.round(param1 / const_797) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),_main,WindowTracker.const_931,_data.userId),_callerFrame,var_1070,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_882.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(_main.getXmlWindow("user_info"));
            var_882.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ModActionCtrl(_main,_data.userId,_data.userName,var_1260),_callerFrame,var_1070,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new SendMsgsCtrl(_main,_data.userId,_data.userName,var_1260),_callerFrame,var_1070,false,true);
      }
