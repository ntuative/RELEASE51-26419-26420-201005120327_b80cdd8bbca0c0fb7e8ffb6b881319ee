package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1174:int = 7;
      
      public static const const_1017:int = 3;
      
      public static const const_1309:int = 8;
      
      public static const const_931:int = 5;
      
      public static const const_1323:int = 1;
      
      public static const const_1215:int = 2;
      ...
      {
         var_1514 = new Dictionary();
         super();
      }
      
      private function getWindowsForType(param1:int) : Dictionary
      {
         var _loc2_:Dictionary = var_1514[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1514[param1] = _loc2_;
         }
         return _loc2_;
      }
