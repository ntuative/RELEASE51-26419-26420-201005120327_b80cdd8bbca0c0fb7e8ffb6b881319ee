package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2413:Dictionary;
      ...
      private var var_916:RoomCreateViewCtrl;
      
      private var var_2151:RoomThumbnailRenderer;
      
      private var var_204:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_630:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_406:Tabs;
      
      private var var_281:MainViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_281 = new MainViewCtrl(this);
         var_630 = new RoomInfoViewCtrl(this);
         var_916 = new RoomCreateViewCtrl(this);
         var_2151 = new RoomThumbnailRenderer(this);
         var_1016 = new GuestRoomPasswordInput(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_281.startSearch(Tabs.const_212,Tabs.const_330,param1);
         var_281.mainWindow.activate();
      }
      ...
      {
         if(param1 != null && var_204 != null)
         {
            var_204.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_204 != null)
         {
            var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_131,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_131,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_281.startSearch(Tabs.const_274,Tabs.const_200);
         var_406.getTab(Tabs.const_274).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_281.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
