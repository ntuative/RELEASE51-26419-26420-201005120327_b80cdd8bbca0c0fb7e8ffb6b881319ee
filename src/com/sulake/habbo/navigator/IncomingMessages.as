package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_172,HabboToolbarIconEnum.EXITROOM);
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_181 && _navigator.sessionData.userName != _loc2_.data.ownerName)
            {
