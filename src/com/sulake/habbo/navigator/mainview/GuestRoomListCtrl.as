package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_1261:IWindowContainer;
      ...
      private var var_385:IScrollbarWindow;
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         if(var_1261 != null)
         {
            _loc2_ = var_1261.tags[0];
            var_1261.color = getBgColor(_loc2_);
         }
         var_1261 = param1;
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         var_385 = IScrollbarWindow(var_20.findChildByName("scroller"));
      }
      
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         var _loc2_:WindowMouseEvent = WindowMouseEvent(param1);
         var _loc3_:int = Math.abs(var_1934 - _loc2_.stageX);
         var_1934 = _loc2_.stageX;
         var_1933 = _loc3_ > 2;
      }
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         _navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_181,null,0);
         ...
         var_859.refreshUserCount(param2.maxUserCount,param1,param2.method_2,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_273)
         {
