package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1071:TextFieldManager;
      
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_526 = new Timer(100);
         var_526.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_40 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_1071 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_526)
         {
            var_526.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_526.reset();
            var_526 = null;
         }
      }
      ...
      {
         var_1071.goBackToInitialState();
         var_1071.input.textBackgroundColor = 4294967295;
         var_884 = var_40[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_59,HabboWindowStyle.const_43,HabboWindowParam.const_74,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1071.getText();
      ...
      {
         var _loc1_:Boolean = var_1071.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!var_1301 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1301 = true;
            _loc3_.y = 1;
