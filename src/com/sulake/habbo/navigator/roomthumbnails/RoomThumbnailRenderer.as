package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1149:int = -16;
      
      private static const const_813:int = 32;
      
      private static const const_1147:int = 8;
      
      public static const const_407:int = 10;
      ...
      private var var_937:ThumbnailImageConfigurations;
      
      private var var_1374:BitmapData;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_937 = new ThumbnailImageConfigurations(_navigator);
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(_navigator.windowManager.createWindow("bitmap","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_40,0 | (!!param3 ? HabboWindowParam.const_44 : HabboWindowParam.const_40),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_937.getImage(ThumbnailEditorModel.const_37,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1149,_loc4_.y + const_1148 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2225[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_937.getImage(ThumbnailEditorModel.const_42,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_937.getImage(ThumbnailEditorModel.const_42,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_937.getImage(ThumbnailEditorModel.const_58,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_813 / 2);
         return new Point(param1 * const_813 + _loc3_,param2 * const_1147);
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1374 == null)
         {
            var_1374 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1374,var_1374.rect,new Point(0,0),null,null,true);
      }
   }
}
