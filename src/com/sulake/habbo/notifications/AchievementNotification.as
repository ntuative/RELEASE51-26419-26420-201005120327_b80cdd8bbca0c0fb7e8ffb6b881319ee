package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1670 = param2;
         var_349 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_125,onBadgeImageReady);
         ...
         var_194 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_2224 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_194);
      ...
      public function dispose() : void
      {
         if(var_349 != null)
         {
            var_349.events.removeEventListener(BadgeImageReadyEvent.const_125,onBadgeImageReady);
            var_349 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_768,var_2224);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_768,var_768));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_768,var_768));
         _localizations.registerParameter(param1,"level",var_1670.toString());
         _localizations.registerParameter(param1,"name",var_349.userName);
         _localizations.registerParameter(param1,"realname",var_349.realName);
      }
   }
}
