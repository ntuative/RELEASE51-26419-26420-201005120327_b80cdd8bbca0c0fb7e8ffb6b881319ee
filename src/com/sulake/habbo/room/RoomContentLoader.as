package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_808:String = "selection_arrow";
      
      private static const const_806:String = "tile_cursor";
      
      private static const const_289:String = "RCL_PUBLICROOM_";
      ...
      private static const const_1139:String = const_366;
      ...
      public static const const_692:String = "RCL_LOADER_READY";
      ...
      private var var_1093:IEventDispatcher = null;
      
      private var var_1339:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_536 = [];
         _wallItems = [];
         var_2158 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_325,_loc4_);
      ...
      private function method_7(param1:String) : String
      {
         var _loc2_:* = null;
         if(var_434 != null)
         {
            _loc2_ = var_434.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         while(_loc5_ < _loc3_.length())
         {
            ...
            _loc7_ = const_289 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      private function initFurniData() : void
      {
         ...
         var _loc1_:Array = var_349.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      {
         if(var_178 != null && var_178.hasWorldType(const_289 + param1))
         {
            return var_178.type;
         }
         return param1;
      ...
      public function dispose() : void
      {
         ...
         if(var_370 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_370.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      {
         return [const_366,const_514,ROOM_CONTENT,const_806,const_808];
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_34 || _loc2_ == RoomObjectCategoryEnum.const_32)
         {
            ...
            return int(var_537.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2158.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_165 && _loc5_ != RoomObjectLogicEnum.const_129)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_538.getValue(param1) as String;
      ...
      {
         if(var_623.getValue(param1) != null)
         {
            return var_623.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_2154.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               ...
               var_1339.add(_loc5_,_loc8_);
               var_178 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_325,_loc5_);
         }
         else
         {
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_435 != null)
         {
            _loc2_ = var_435.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1388);
               return;
            }
         }
      }
      ...
      {
         var _loc3_:String = var_535.getValue(param1) as String;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_269;
         }
         return RoomObjectCategoryEnum.const_211;
      }
      ...
      private function continueInitilization() : void
      {
         if(var_2152)
         {
            ...
            if(var_1093 != null)
            {
               var_1093.dispatchEvent(new Event(const_692));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_178 != null)
         {
            return var_178.getWorldHeightScale(const_289 + param1);
         }
         return 1;
      }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               var_623.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               var_538.add(_loc3_,_loc4_);
               if(var_536.indexOf(_loc7_) < 0)
               {
                  var_536.push(_loc7_);
               }
            }
            ...
            _loc8_ = var_537.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               var_537.remove(_loc7_);
               var_537.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         var_1093 = param1;
         var_2155 = param2.getKey("flash.dynamic.download.url","furniture/");
         var_2157 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         var_2156 = param2.getKey("public.room.dynamic.download.url","");
         var_2153 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         var_34 = const_807;
         initFurniData();
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_370.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_435 != null)
         {
            ...
            var_435.add(param1,param2);
         }
         if(var_434 != null)
         {
            var_434.remove(param2);
            var_434.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_165 && _loc5_ != RoomObjectVisualizationEnum.const_129)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_455.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_289 + param1) == RoomObjectCategoryEnum.const_69)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1339.getValue(param1) != null)
         {
            var_178 = var_1339.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_450,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_178 != null)
         {
            return var_178.getWorldScale(const_289 + param1);
         }
         return 32;
      }
   }
