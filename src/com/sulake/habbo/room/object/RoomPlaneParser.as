package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_833:Number = 0;
      
      private var var_345:int = 0;
      
      private var var_344:int = 0;
      
      private var var_112:Number = 0;
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_933;
         }
      ...
      {
         var _loc11_:* = null;
         addPlane(RoomPlaneData.const_155,param1,param2,param3,[param4]);
         addPlane(RoomPlaneData.const_278,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -var_833);
         addPlane(RoomPlaneData.const_155,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            addPlane(RoomPlaneData.const_155,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + var_112) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            addPlane(RoomPlaneData.const_155,Vector3d.sum(param1,Vector3d.product(param3,-var_112 / param3.length)),Vector3d.product(param3,(param3.length + var_112) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,var_833 / param2.length);
               addPlane(RoomPlaneData.const_155,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc11_,-1)),_loc11_,_loc10_,[_loc9_,param2,param4]);
            }
         }
      }
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         var_691 = getFloorHeight(var_102);
         if(!param1)
         {
            createWallPlanes();
         }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < _width && param2 >= 0 && param2 < _height)
         {
            ...
            else
            {
               ...
               if(param2 == var_347 || param2 == var_344)
               {
                  _loc7_ = false;
                  _loc8_ = var_346;
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number) : void
      {
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_149,_loc13_,new Vector3d(0,0,-var_112),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,0,var_112,param8);
                  }
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param9,var_112,param9);
                  }
               }
            }
            if(param7)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_149,_loc13_,new Vector3d(0,0,-var_112),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
                     _loc14_.addMask(0,0,var_112,param9);
                  }
                  if(param8 > 0)
                  {
                     _loc14_.addMask(0,param2.length - param8,var_112,param8);
                  }
               }
            }
            if(param4)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_149,_loc13_,new Vector3d(0,0,-var_112),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,0,var_112,param11);
                  }
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param10,var_112,param10);
                  }
               }
            }
            if(param5)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_149,_loc13_,new Vector3d(0,0,-var_112),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
                     _loc15_.addMask(0,0,var_112,param10);
                  }
                  if(param11 > 0)
                  {
                     _loc15_.addMask(0,param3.length - param11,var_112,param11);
                  }
               }
            }
         }
