package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1533:int = 1500;
      
      private var var_1534:int = 255;
      
      private var var_1532:int = 255;
      
      private var var_1293:uint = 16777215;
      
      private var var_1066:uint = 16777215;
      
      protected var var_78:RoomPlaneParser = null;
      
      private var var_878:int = 0;
      
      private var var_1226:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_758:
                  _loc2_.setString(RoomObjectVariableEnum.const_658,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_666:
                  _loc2_.setString(RoomObjectVariableEnum.const_559,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_677:
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_436:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_232)
                  {
                     _loc8_ = "null";
                  }
                  ...
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_646:
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_940,int(_loc5_.bgOnly));
            var_1293 = _color;
            var_1534 = var_1226;
            var_1066 = _loc11_;
            var_1532 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_968,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_667,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1194,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1403,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1404,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_155 || _loc13_ == RoomPlaneData.const_278)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_878)
         {
            ...
            else
            {
               ...
               _loc9_ = var_1293 & 255;
               _loc10_ = var_1066 >> 16 & 255;
               _loc11_ = var_1066 >> 8 & 255;
               _loc12_ = var_1066 & 255;
               _loc13_ = (_loc2_ - var_878) / var_1533;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1534 + (var_1532 - var_1534) * _loc13_;
               _color = _loc3_;
               var_1226 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_667,_loc3_);
         }
      }
   }
}
