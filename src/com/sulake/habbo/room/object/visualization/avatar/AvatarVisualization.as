package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_498:BitmapDataAsset;
      
      private const const_1099:int = 3;
      
      private const const_1707:int = 2;
      
      private var var_696:AvatarVisualizationData = null;
      ...
      {
         var_696 = param1 as AvatarVisualizationData;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc9_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_673);
         var _loc10_:int = _loc4_.getNumber(RoomObjectVariableEnum.const_682);
         ...
         var _loc13_:int = param2 - var_1243;
         ...
         var _loc16_:Boolean = var_293 != _loc3_.getUpdateID() || var_216 != param1.scale || var_165 != _loc4_.getUpdateID();
         var _loc17_:Boolean = var_416 || var_497 > 0;
         if(_loc16_ || _loc17_)
         {
            increaseUpdateId();
            --var_497;
            ...
            if(var_302 != _loc7_)
            {
               for each(_loc40_ in var_310.getKeys())
               {
                  _loc41_ = var_310.getValue(_loc40_) as IAvatarImage;
                  if(_loc41_)
                  {
                     _loc41_.dispose();
                  }
                  var_310.remove(_loc40_);
               }
               if(_loc6_)
               {
                  _loc6_.dispose();
            ...
            if(_loc6_ == null)
            {
               _loc42_ = _loc4_.getString(RoomObjectVariableEnum.const_993);
               _loc6_ = var_696.getAvatar(_loc7_,param1.scale,_loc42_);
               if(_loc6_ == null)
               {
                  return;
               }
            ...
            _loc21_ = _loc4_.getNumber(RoomObjectVariableEnum.const_350);
            if(isNaN(_loc21_) || _loc4_.getString(RoomObjectVariableEnum.const_275) == "float")
            {
               _loc21_ = _loc20_;
            }
            else
            ...
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_275);
            _loc23_ = _loc4_.getString(RoomObjectVariableEnum.const_683);
            _loc6_.appendAction(AvatarAction.const_708,_loc22_,_loc23_);
            _loc24_ = false;
            if(_loc22_ == "lay")
            {
               _loc43_ = int(_loc23_);
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_494);
            if(_loc25_ > 0 && _loc6_.getScale() == AvatarScaleType.const_56)
            {
               _loc44_ = _loc4_.getNumber(RoomObjectVariableEnum.const_451);
               _loc45_ = 3;
               _loc46_ = param2 - _loc44_;
               if(_loc46_ < _loc45_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_321,AvatarAction.const_1346[_loc25_]);
               }
            }
            _loc26_ = _loc4_.getNumber(RoomObjectVariableEnum.const_833);
            if(_loc26_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_908,_loc26_);
            }
            _loc27_ = _loc4_.getNumber(RoomObjectVariableEnum.const_1030);
            if(_loc27_ > 0)
            {
               _loc47_ = _loc4_.getNumber(RoomObjectVariableEnum.const_967);
               _loc48_ = 5;
               _loc49_ = param2 - _loc47_;
               if(_loc49_ < _loc48_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_874,_loc27_);
               }
            }
            _loc28_ = _loc4_.getNumber(RoomObjectVariableEnum.const_529);
            _loc29_ = 0;
            if(_loc28_ > 0)
            {
               _loc50_ = _loc4_.getNumber(RoomObjectVariableEnum.const_696);
               _loc51_ = 100;
               _loc52_ = param2 - _loc50_;
               if(_loc52_ < _loc51_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_999,_loc28_);
                  _loc53_ = 1;
                  while(_loc53_ < 10)
                  {
            ...
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_1048);
            if(_loc29_ > 0)
            {
               _loc30_ = _loc29_;
            }
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_923,_loc30_);
            }
            if(_loc8_)
            {
               _loc6_.appendAction(AvatarAction.const_403);
            }
            ...
            if(_loc14_)
            {
               _loc6_.appendAction(AvatarAction.const_489);
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_866);
            if(_loc32_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_578,_loc32_);
            }
            ...
            if(_loc22_ == "mv" || _loc22_ == "std")
            {
               ...
               if(var_496 != null)
               {
                  _loc35_.asset = var_496.content as BitmapData;
            ...
            var_498 = null;
            _loc35_ = getSprite(const_1707);
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_939))
            {
               _loc35_.visible = true;
               switch(param1.scale)
               {
                  case 32:
                     var_498 = var_696.getAvatarRendererAsset("user_typing_small_png") as BitmapDataAsset;
                     _loc67_ = 3;
                     _loc68_ = -42;
                     break;
                  case 64:
                     var_498 = var_696.getAvatarRendererAsset("user_typing_png") as BitmapDataAsset;
                     _loc67_ = 14;
                     _loc68_ = -83;
               }
               if(var_498 != null)
               {
                  _loc35_.asset = var_498.content as BitmapData;
            ...
            var_846.push(getTimer() - _loc19_);
            if(false)
            {
               _loc69_ = 0;
               _loc70_ = "[";
               for each(_loc71_ in var_846)
               {
                  _loc69_ += _loc71_;
                  _loc70_ += "," + _loc71_;
               }
