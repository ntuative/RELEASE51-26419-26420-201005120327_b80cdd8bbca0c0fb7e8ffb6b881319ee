package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_772:int = 15;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_992[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_990[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_992 = new Array();
         var_992.push(Math.random() * _loc2_ * 1.5);
         var_992.push(Math.random() * _loc2_ * 1.5);
         var_991 = new Array();
         var_991.push(1);
         var_991.push(-1);
         var_989 = new Array();
         var_989.push(const_1068);
         var_989.push(const_1067);
         var_990 = new Array();
         var_990.push(getRandomAmplitudeFactor());
         var_990.push(getRandomAmplitudeFactor());
      }
