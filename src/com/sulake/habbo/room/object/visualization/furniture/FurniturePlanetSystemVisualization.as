package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1034);
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_228 != null)
         {
            ...
            {
               _loc2_ = var_228[_loc3_];
               _loc2_.update(var_597,var_1914,param1);
               _loc3_++;
            }
