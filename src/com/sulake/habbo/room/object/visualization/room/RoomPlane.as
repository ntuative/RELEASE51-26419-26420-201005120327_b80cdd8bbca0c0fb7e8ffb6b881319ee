package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_199:int = 3;
      ...
      private var var_727:IPlaneRasterizer = null;
      ...
      private var var_648:PlaneMaskManager = null;
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_231 || _type == const_199))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_873 || false && false && !var_154 || var_648 == null)
         {
            return;
         }
         ...
         if(var_154)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(var_518);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < var_206.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  var_648.updateMask(var_62,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < var_266.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  var_1060.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            var_154 = false;
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         if(var_727 != null)
         {
            return var_727.getTextureIdentifier(param1,normal);
         }
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(_type == const_231 || _type == const_199)
         {
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            if(var_727 != null)
            {
               _loc3_ = var_727.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1524,var_2013,var_2010,var_2014,var_2011,param2);
               if(_loc3_ != null)
               {
