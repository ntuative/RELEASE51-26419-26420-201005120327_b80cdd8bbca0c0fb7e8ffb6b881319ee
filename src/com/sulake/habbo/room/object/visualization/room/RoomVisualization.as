package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1223:int = 10066329;
      
      private static const const_767:int = 13421772;
      
      public static const const_1164:int = 16777215;
      ...
      public static const const_1408:int = 13421772;
      ...
      private var var_987:uint = 16777215;
      ...
      private var var_567:Rectangle = null;
      
      private var var_1706:int = 255;
      
      private var var_1705:Boolean = false;
      
      private var var_1707:int = 255;
      
      private var var_1699:String = null;
      
      private const const_1696:int = 250;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_968);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1036);
         var _loc7_:int = 0;
         while(_loc7_ < var_78.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_155)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_231,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_199,true,_loc11_,_loc6_,_loc5_,0,_loc3_,_loc4_);
               if(_loc14_.y > 0)
               {
               ...
               {
                  _loc13_.color = const_1408;
               }
               else
               {
                  _loc13_.color = const_1223;
               }
               if(_data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1350)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_231,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_231 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_567 == null)
         {
            var_567 = super.boundingRectangle;
         }
         return new Rectangle(var_567.x,var_567.y,var_567.width,var_567.height);
      }
         ...
         while(_loc5_ < var_392.maskCount)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc9_ < var_103.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_231 || _loc3_.type == RoomPlane.const_199 && _loc8_ == RoomPlaneBitmapMaskData.const_232)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + include;
                        if(var_78.getPlaneType(_loc9_) == RoomPlaneData.const_149)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1348)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_1098 || _loc9_.y != var_1708 || _loc9_.z != var_1703 || param1.scale != var_1702))
            {
               var_1098 = _loc9_.x;
               var_1708 = _loc9_.y;
               var_1703 = _loc9_.z;
         ...
         if(var_165 != _loc6_.getUpdateID())
         {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_667));
            if(_loc11_ != var_987)
            {
               var_987 = _loc11_;
               var_1707 = var_987 & 255;
               var_1706 = var_987 >> 8 & 255;
               var_1704 = var_987 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1700 + const_1696 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1700 = _loc7_;
         if(var_165 != _loc6_.getUpdateID())
         {
            ...
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_588);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1701 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_940));
         ...
         while(_loc8_ < var_393.length)
         {
            ...
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_199)
            {
               if(var_1701)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_1707 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_1706 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_1704 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_103.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_231 && param2 != null)
               {
                  _loc5_.id = param2;
               }
               else if(_loc5_.type == RoomPlane.const_199 && param3 != null)
               {
                  _loc5_.id = param3;
               }
            }
