package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1107:UserDataManager;
      ...
      {
         if(var_34 == RoomSessionEvent.const_334 && _connection != null)
         {
            var_34 = RoomSessionEvent.const_96;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1107 as IUserDataManager;
      }
