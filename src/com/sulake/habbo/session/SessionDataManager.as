package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1453:UserTagManager;
      ...
      private var var_1452:GroupDetailsView;
      
      private var _name:String;
      
      private var var_478:int = 0;
      
      private var var_575:FurnitureDataParser;
      ...
      private var var_1190:BadgeImageManager;
      ...
      private var var_818:IgnoredUsersManager;
      ...
      private var var_479:ProductDataParser;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_684 = [];
         var_1453 = new UserTagManager(events);
         var_1007 = new HabboGroupInfoManager(this,events);
         var_818 = new IgnoredUsersManager(this);
      ...
      {
         var _loc2_:* = null;
         var_479.removeEventListener(ProductDataParser.const_105,onProductsReady);
         var_1454 = true;
      ...
      {
         return var_1453.getTags(param1);
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         ...
         var_575 = new FurnitureDataParser(_loc2_,var_408,_wallItems,var_407,_localization);
         var_575.addEventListener(FurnitureDataParser.const_105,onFurnitureReady);
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_575)
         {
            var_575.removeEventListener(FurnitureDataParser.const_105,onFurnitureReady);
            var_575.dispose();
            var_575 = null;
         }
         if(var_479)
      ...
      {
         return var_1190.getBadgeImage(param1,BadgeImageManager.const_974);
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         var_478 = _loc3_.petRespectLeft;
         var_302 = _loc3_.figure;
         var_587 = _loc3_.sex;
         var_1154 = _loc3_.realName;
         var_818.initIgnoreList();
      }
      ...
      {
         return var_818.isIgnored(param1);
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         var_1798 = _loc2_.isOpen;
         var_1797 = _loc2_.onShutDown;
      }
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(var_816.indexOf(param1) == -1)
         {
            var_816.push(param1);
         }
         if(var_479 == null)
         {
            _loc2_ = var_161.getKey("productdata.load.url");
            _loc3_ = var_161.getKey("external.hash");
            _loc2_ = _loc2_.replace("%hash%",_loc3_);
            var_479 = new ProductDataParser(_loc2_,var_842);
            var_479.addEventListener(ProductDataParser.const_105,onProductsReady);
         }
         return false;
      }
      ...
      {
         return var_1190.getBadgeImage(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         if(var_1452 == null)
         {
            var_1452 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = var_1007.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            var_1452.showGroupDetails(param1);
         }
      }
      ...
      {
         var _loc2_:IConnection = _communication.getHabboMainConnection(null);
         if(param1 < 0 || var_478 < 1 || _loc2_ == null)
         {
      ...
      {
         if(false && var_576.indexOf(param1) == -1)
         {
            var_576.push(param1);
            return null;
         }
         var _loc2_:Array = var_408.getValues();
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            var_302 = _loc2_.figure;
            var_587 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(_id,var_302,var_587));
         }
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_1453.communication = _communication;
         var_1007.communication = _communication;
         var_818.registerMessageEvents();
      }
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return var_408.getValue(param1.toString());
      }
      ...
      private function initBadgeImageManager() : void
      {
         ...
         var_1190 = new BadgeImageManager(_loc1_,events,var_161,_localization);
      }
