package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      public function method_13(param1:int) : void
      {
         var _loc2_:int = _userIds.getValue(param1);
         var_458.remove(_loc2_);
      ...
      {
         return var_458.getValue(param1);
      }
      ...
      public function getUserBadges(param1:int) : Array
      {
         ...
         var _loc2_:* = var_782.getValue(param1) as Array;
         if(_loc2_ == null)
         {
            _loc2_ = [];
         }
      ...
      {
         var_458.remove(param1.webID);
         _userIds.remove(param1.id);
         var_458.add(param1.webID,param1);
