package com.sulake.habbo.session.handler
{
   ...
   public class RoomSessionHandler extends BaseHandler
   {
      ...
      public static const const_1040:String = "RS_CONNECTED";
      
      public static const const_714:String = "RS_DISCONNECTED";
      
      public static const const_896:String = "RS_READY";
      ...
      private function onRoomQueueStatus(param1:RoomQueueStatusMessageEvent) : void
      {
         ...
         var _loc3_:IRoomSession = listener.getSession(_xxxRoomId,var_36);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function onRoomDisconnected(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:int = var_36;
         if(listener)
         {
            listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_714);
         }
      }
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         if(listener)
         {
            ...
            listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_896);
         }
      }
      ...
      private function onYouAreSpectator(param1:YouAreSpectatorMessageEvent) : void
      {
         ...
         var _loc2_:IRoomSession = listener.getSession(_xxxRoomId,var_36);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function onRoomConnected(param1:IMessageEvent) : void
      {
         ...
         if(listener)
         {
            listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_1040);
         }
      }
   }
}
