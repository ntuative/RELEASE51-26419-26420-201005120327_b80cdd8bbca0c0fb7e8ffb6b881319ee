package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_308.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_840,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_174,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_172,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_50,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_369,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_707,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_917,onHideWindowEvent);
         var_34 = true;
