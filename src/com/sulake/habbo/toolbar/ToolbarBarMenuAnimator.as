package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1102:Number = 25;
      ...
      private var var_1037:ToolbarView;
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_505.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_505.splice(_loc3_,1);
            var_504.splice(_loc3_,1);
         }
         var_504.push(param1.name);
         var_505.push(param2);
         param1.addEventListener(WindowEvent.const_469,windowEventListener);
         param1.addEventListener(WindowEvent.const_238,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_505[var_504.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1037.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_306.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_306.splice(var_306.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1037.getIconLoc(param1.iconId);
      ...
      {
         return var_504[var_505.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_306[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_598[_loc3_] = new Array();
            }
            if(var_598[_loc3_].indexOf(param1) < 0)
            {
               var_598[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_786 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_786 || param1.desktop.height - param1.y < const_1103;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_504.length)
         {
            if(var_504[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_598[_loc3_].length)
                  {
                     repositionWindow(var_598[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
