package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIcon
   {
      ...
      private var var_432:ToolbarIconAnimator;
      
      private var var_622:Array;
      
      private var var_905:Array;
      
      private var var_904:String = "-1";
      
      private var var_2412:Boolean = true;
      ...
      public function ToolbarIcon(param1:ToolbarIconGroup, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IEventDispatcher, param6:ToolbarBarMenuAnimator)
      {
         ...
         var_100 = param2.createWindow("TOOLBAR_ICON_" + param4 + "_REGION","",WindowType.const_398,HabboWindowStyle.const_40,HabboWindowParam.const_44,new Rectangle(0,0,1,1),onMouseEvent) as IRegionWindow;
      ...
      {
         return var_1561[var_1086.indexOf(param1)];
      }
      ...
      private function onMouseEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               if(var_272)
               {
                  var_272.repositionWindow(var_749,true);
               }
               if(_events != null)
               {
                  _loc4_ = new HabboToolbarEvent(HabboToolbarEvent.const_64);
                  _loc4_.iconId = var_749;
      ...
      {
         return var_622.indexOf(param1) > -1;
      }
      ...
      public function menuLockedToIcon(param1:String) : Boolean
      {
         ...
         var _loc2_:MenuSettingsItem = var_905[var_622.indexOf(param1)];
      ...
      private function setTooltip() : void
      {
         ...
         {
            var_100.toolTipCaption = "${toolbar.icon.tooltip." + var_2146.toLowerCase() + "}";
         }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Number, param4:String, param5:Point) : void
      {
         if(var_272 != null)
         {
            var_272.animateWindowIn(this,param1,param2,var_749,param3,param4,getMenuYieldList(param1));
         }
      }
      
      private function updateAnimator(param1:Event) : void
      {
         if(var_432 != null && _window != null)
         {
            var_432.update(_window);
            if(var_432.hasNextState())
            {
               state = var_432.nextState;
            }
         }
      }
      ...
      public function defineFromXML(param1:XML) : void
      {
         ...
         var_1086 = new Array();
         var_2146 = param1.@id;
         var_2145 = int(param1.@window_offset_from_icon);
         var_1883 = int(param1.@window_margin);
         ...
         if(_loc2_.length() > 0)
         {
            ...
            while(_loc3_ < _loc2_.length())
            {
               ...
               var_1086.push(_loc5_.id);
               var_1561.push(_loc5_);
               if(_loc3_ == 0)
               {
                  if(var_1088 == "-1")
                  {
      ...
      public function hideWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(var_272 != null)
         {
            var_272.hideWindow(param1,param2,var_749,param3);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer, param3:Number, param4:String) : void
      {
         if(var_272 != null)
         {
            var_272.positionWindow(this,param1,param2,var_749,param3,getMenuYieldList(param1));
         }
      }
      ...
      private function setAnimator() : void
      {
         ...
         var _loc1_:StateItem = getCurrentStateObject();
         if(_loc1_ != null && var_1087)
         {
            if(_loc1_.frames == null)
            {
               return;
            }
            var_432 = new ToolbarIconAnimator(_loc1_,_assetLibrary,_window,var_87,_y,_bitmapData);
            if(false)
            {
      ...
      {
         return var_1883 + var_534.windowMargin;
      }
