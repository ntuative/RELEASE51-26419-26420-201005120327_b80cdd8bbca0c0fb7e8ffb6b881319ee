package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_1379 = param1.loop;
         if(param1.background != null)
         {
            var_942 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_941.push(new XML());
               var_940.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_940[var_55] = param6.clone();
         }
      ...
      {
         if(var_1379 == true || var_770 == 0)
         {
            if(false)
            {
               ++var_55;
               if(var_55 >= var_941.length)
               {
                  var_55 = 0;
                  ++var_770;
               }
      ...
      {
         return var_1379 == false && var_770 == 1 && var_1376 != var_34;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_942 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_942.width),Math.max(param2.height,var_942.height));
            _loc3_.copyPixels(var_942,var_942.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_55 <= var_940.length)
         {
            _loc2_ = var_940[var_55];
