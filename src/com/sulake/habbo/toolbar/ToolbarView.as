package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1506:Number = 15;
      
      private var _events:IEventDispatcher;
      
      private var var_272:ToolbarBarMenuAnimator;
      
      private var var_1505:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_205 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_59,HabboWindowStyle.const_1012,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1045 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_1045)
         {
         ...
         var_1506 = _loc7_.toolbar.@min_group_margin;
         var_1505 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_263,param1,param2,_window,var_272);
         createGroupsFromXmlList(_loc9_,var_603,param1,param2,var_205,var_272);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_134,var_513,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1506,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1272) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1506,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1272) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_134,var_513);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_603.length)
         {
            _loc2_ = var_603[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_134,var_513);
         }
      }
