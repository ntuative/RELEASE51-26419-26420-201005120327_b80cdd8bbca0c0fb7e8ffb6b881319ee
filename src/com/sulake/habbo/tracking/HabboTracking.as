package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_817:uint = 11;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1391 = new Array(const_817);
         var _loc4_:int = 0;
         while(_loc4_ < const_817)
         {
            var_1391[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1243,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1337,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1245,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_728,String(false));
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1336);
               break;
            case HabboCommunicationEvent.const_697:
               trackLoginStep(HabboLoginTrackingStep.const_1341,String(_communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_227:
               ...
               trackLoginStep(HabboLoginTrackingStep.const_227);
               if(var_246 != null)
               {
                  var_246.init();
               }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_310:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_161)
         {
            ...
            if(var_246 != null)
            {
               var_246.configuration = var_161;
            }
            if(var_245 != null)
            {
               var_245.configuration = var_161;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_259.events.addEventListener(AdEvent.const_372,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_728,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_697,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_227,onConnectionEvent);
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_378:
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_52)
            {
               var_52.release(new IIDHabboRoomWidget());
               var_52 = null;
            }
            if(_navigator)
            {
            ...
            if(var_184)
            {
               if(true)
               {
                  ...
                  Component(var_184).events.removeEventListener(HabboFriendListTrackingEvent.const_310,onFriendlistTrackingEvent);
               }
            ...
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_378,onLagWarningEvent);
               }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_976);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_976,onCoreRunning);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1123 > -1 && _loc2_ < var_1123)
         {
            ++var_1619;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1619);
         }
         if(var_1123 > -1 && _loc2_ - var_1123 > 15000)
         {
            ++var_1620;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1620);
         }
         var_1123 = _loc2_;
         if(var_245 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_378,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_277,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_184).events.addEventListener(HabboFriendListTrackingEvent.const_310,onFriendlistTrackingEvent);
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            trackLoginStep(HabboLoginTrackingStep.const_1171);
         }
         else if(param1.type == HabboHotelViewEvent.const_68)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1248);
         }
      }
   }
}
