package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1354 || var_1446 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1447 == 0 || _loc1_ - var_1447 > var_1446)
         {
            if(_connection != null)
            {
      ...
      {
         var_1354 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1446 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
