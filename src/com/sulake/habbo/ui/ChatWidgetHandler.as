package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      private var var_875:Number = 0;
      
      private var var_521:Point = null;
      ...
      {
         return [RoomWidgetChatMessage.const_745,RoomWidgetChatSelectAvatarMessage.const_754];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_745:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_148,_container.roomSession,0,"Version 26419-26420-201005120242");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_754:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_875 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_875);
            }
            if(var_521 == null)
            {
               var_522.x = 0;
               var_522.y = 0;
               var_522.z = 0;
               var_521 = _loc4_.getScreenPoint(var_522);
               var_875 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_522.x = 0;
            var_522.y = 0;
            var_522.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_522);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_521.x || _loc8_.y != var_521.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_521,_loc5_));
