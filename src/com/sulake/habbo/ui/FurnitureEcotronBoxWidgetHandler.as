package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         var _loc3_:RoomWidgetEcotronBoxDataUpdateEvent = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_87,0,_name,false,param2);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_581,RoomWidgetEcotronBoxOpenMessage.const_721,RoomWidgetEcotronBoxOpenedMessage.const_1366];
      }
            ...
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_247:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     if(_loc3_ != null)
                     {
                        _loc5_ = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_87,0,_name,false,_loc3_.data);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_581:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_721:
