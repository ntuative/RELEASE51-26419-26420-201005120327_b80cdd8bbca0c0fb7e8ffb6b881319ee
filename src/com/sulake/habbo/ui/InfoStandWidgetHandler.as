   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_154,onUserTags);
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_125,onBadgeImage);
            }
            if(false)
            {
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_154,onUserTags);
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_125,onBadgeImage);
         }
         if(false)
         {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_565);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_335);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_861);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1031);
            ...
            case RoomObjectCategoryEnum.const_38:
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_954)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_529);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_215)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_607);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1227;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_929;
                  }
                  if(!_loc27_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1368);
               }
               else
               {
               ...
               if(_loc19_ != null)
               {
                  _loc19_.setDirection(AvatarSetType.const_41,4);
                  _loc13_.image = _loc19_.getImage(AvatarSetType.const_41,true);
                  _loc19_.dispose();
               }
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_586.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_56);
            var_586.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            _loc9_ = new RoomWidgetPetInfoUpdateEvent(_loc6_,_loc7_,_loc3_.name,_loc2_.petId,_loc5_.getCroppedImage(AvatarSetType.const_41),_loc8_,_loc2_.ownerId,_loc2_.ownerName,_loc3_.id);
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_607);
      ...
      {
         return [RoomSessionUserBadgesEvent.const_134];
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_322);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_573);
         _loc1_.push(RoomWidgetFurniActionMessage.const_554);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_569);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_681);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1295);
         _loc1_.push(RoomWidgetPetCommandMessage.const_639);
         _loc1_.push(RoomWidgetPetCommandMessage.const_601);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_134:
      ...
      public function dispose() : void
      {
         ...
         if(var_586 != null)
         {
            _loc1_ = var_586.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_586.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_399)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_322:
            ...
            case RoomWidgetUserActionMessage.const_552:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_898,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_620:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_573:
            ...
            case RoomWidgetUserActionMessage.const_385:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_569:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_681:
            ...
            case RoomWidgetUserActionMessage.const_613:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_601:
