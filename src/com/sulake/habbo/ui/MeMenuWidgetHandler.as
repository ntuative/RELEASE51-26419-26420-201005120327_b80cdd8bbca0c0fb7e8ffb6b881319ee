   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(false)
         {
            ...
            if(_loc6_ != null)
            {
               _loc6_.setDirection(AvatarSetType.const_47,3);
               _loc2_ = _loc6_.getCroppedImage(AvatarSetType.const_47);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_204 + " " + _loc7_);
            if(var_204 != null && _loc7_ != null)
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_840,HabboToolbarIconEnum.MEMENU);
               _loc9_.bitmapData = _loc7_;
               var_204.events.dispatchEvent(_loc9_);
            }
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_411,method_6);
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_108,method_6);
            }
            _container = null;
         }
         _container = param1;
         ...
         if(var_11 != null)
         {
            (var_11 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_865,onAvatarEffectsChanged);
            (var_11 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_907,onHabboClubSubscriptionChanged);
         }
         var_204 = _container.toolbar;
         if(var_204)
         {
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_411,method_6);
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_108,method_6);
         }
         _catalog = _container.catalog;
      }
      
      private function method_6(param1:HabboHelpTutorialEvent) : void
      {
         if(_container == null)
         {
            return;
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_411:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_430));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_702);
         _loc1_.push(RoomWidgetDanceMessage.const_556);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_519);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_715);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_596);
         ...
         _loc1_.push(RoomWidgetStopEffectMessage.const_734);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1280);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_953);
         _loc1_.push(RoomWidgetToolbarMessage.const_623);
         _loc1_.push(RoomWidgetToolbarMessage.const_538);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_329);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1217);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1020);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_592);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_694);
         ...
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_690);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_305);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_756));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetDanceMessage.const_556:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_519:
               if(var_11 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_715:
               if(var_11 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_596:
               if(var_11 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_675:
               ...
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1045)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_223,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_603:
               ...
               if(var_11 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_989:
                        _catalog.openCatalogPage(CatalogPageName.const_1324,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1005:
                        var_11.toggleInventoryPage(InventoryCategory.const_283);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1377:
                        var_11.toggleInventoryPage(InventoryCategory.const_81);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1214:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_734:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_882:
               _loc4_ = param1 as RoomWidgetSetToolbarIconMessage;
               switch(_loc4_.widgetType)
               {
                  case RoomWidgetSetToolbarIconMessage.const_1325:
                     break;
                  default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_953:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_592:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_623:
               ...
               if(var_204)
               {
                  var_204.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_50,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_11 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
               ...
               break;
            case RoomWidgetToolbarMessage.const_538:
               ...
               if(var_204 && false)
               {
                  var_204.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_369,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_329:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_413));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_740:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_317,_container.soundManager.volume));
               break;
            ...
            case RoomWidgetStoreSettingsMessage.const_642:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_317,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_690:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_425));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_305:
               _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_679));
               break;
            default:
