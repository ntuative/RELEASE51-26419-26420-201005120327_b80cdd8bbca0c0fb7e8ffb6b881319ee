package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1459:int = 5;
      
      private static const const_502:int = 16;
      
      private static const const_1136:int = 20;
      
      private static const const_356:int = 10;
      
      private static const const_1137:int = 40;
      ...
      private var var_439:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1085 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_2139 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2140 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_746 = new Timer(1000,1);
         var_746.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_902 = new Timer(5000,1);
         var_902.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window.addEventListener(WindowEvent.const_469,onWindowMoved);
         var_1327 = true;
         var_142 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2141 = _loc2_.width + const_502 + _loc6_.width + const_1136;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1137,_loc8_.width) + const_502);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1085 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_142 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_439);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_439);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_533);
