package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1715:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1716:String = "level";
      
      private var var_107:IItemListWindow;
      
      private const const_1723:String = "energy";
      ...
      private const const_1718:uint = 3355443;
      
      private var var_237:IBorderWindow;
      
      private const const_1721:int = 158;
      
      private const const_1720:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_175:PetCommandTool;
      
      private const const_1717:uint = 11184810;
      
      private const const_1719:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_237 = _window.getListItemByName("info_border") as IBorderWindow;
         if(var_237 != null)
         {
            var_107 = var_237.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_237.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_237.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      {
         if(var_107 == null || var_237 == null || var_64 == null)
         {
            return;
         }
         ...
         var_237.height = NaN;
         _window.width = Math.max(var_237.width,var_64.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1299.getValue(var_607) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1716,param1.level,param1.levelMax);
         updateStateElement(const_1719,param1.experience,param1.experienceMax);
         updateStateElement(const_1723,param1.energy,param1.energyMax);
         ...
         updateWindow();
         var_607 = param1.id;
         var_1299.remove(param1.id);
         var_1299.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_175 && var_175.getPetId() == var_607)
               {
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1721,const_1720,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1717);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1718);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1715);
         return _loc5_;
      }
