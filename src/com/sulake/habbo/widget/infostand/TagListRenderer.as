package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1709:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1328 != null && var_1328.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_865 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_865 += param1.height + const_1709;
            return fit(param1);
         }
         param1.offset(_offsetX,var_865);
         _offsetX += param1.width + const_1710;
         return true;
      }
