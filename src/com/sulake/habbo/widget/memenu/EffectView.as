package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_852 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_851 = _window.findChildByName("loader_bar");
         if(var_851 != null)
         {
            var_439 = var_851.width;
            var_172.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_852 != null)
         {
            var_852.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_852.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
