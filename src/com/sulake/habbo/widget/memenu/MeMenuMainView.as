      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_983);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_950));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_730);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1005));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_249);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1045));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_635);
               break;
            case "news":
               if(false && false)
               {
