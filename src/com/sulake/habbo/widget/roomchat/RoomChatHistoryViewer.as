package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1130:int = 18;
      
      private static const SCROLLBAR_WIDTH:int = 20;
      
      public static const const_1049:int = 3;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_158.state = RoomChatHistoryPulldown.const_201;
         ...
         var_43 = param2.createWindow("chatscroller","",HabboWindowType.const_935,HabboWindowStyle.const_40,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      {
         return !!var_312 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_239 > 0 && param2)
         {
            if(var_1316)
            {
               if(Math.abs(param1 - var_239) <= const_1049)
               {
                  return;
               }
               var_1316 = false;
            ...
            if(var_312)
            {
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(var_43.scrollV < 1 - const_1130 / var_43.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1551)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_312 && !var_1235)
         {
            ...
            var_158.state = RoomChatHistoryPulldown.const_353;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_158.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_201);
      }
