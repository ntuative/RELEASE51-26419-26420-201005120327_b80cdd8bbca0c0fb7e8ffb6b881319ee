package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_502:int = 6;
      
      private static const const_356:int = 10;
      
      private static const const_1059:Number = 18;
      
      private static const const_1434:Number = 10;
      
      private static const const_1435:Number = 8;
       
      
      private var var_1143:Number;
      ...
      {
         _widget.onItemMouseOut(var_976,var_977,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_976,var_664,var_977,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1142 = param1.chatType;
         var_976 = param1.userId;
         var_664 = param1.userName;
         var_977 = param1.userCategory;
         _message = param1.text;
         var_1143 = param1.userX;
         var_190 = param1.userImage;
         var_978 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(var_190 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_388 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_978 != 0)
            {
               _loc30_ = uint(var_978 >> 16 & 255);
               _loc31_ = uint(var_978 >> 8 & 255);
               _loc32_ = uint(var_978 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1142 == RoomWidgetChatUpdateEvent.const_282)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_664);
            }
            else if(var_1142 == RoomWidgetChatUpdateEvent.const_266)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_664);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_388;
            _loc20_.width = _loc20_.textWidth + const_502;
            _width += _loc20_.textWidth + const_502;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_356 + _loc20_.textWidth + const_502;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_976,var_977,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_976,var_977,_roomId,_roomCategory,param1);
      }
