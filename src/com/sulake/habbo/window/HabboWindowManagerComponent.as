package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_360:uint = 3;
      
      private static var _instance:IHabboWindowManager;
      
      private static const const_1082:uint = 1;
      ...
      private var var_1207:ProfilerAgentTask;
      
      private var var_1208:IEventDispatcher;
      
      private var var_2399:uint = 0;
      
      private var var_1209:ProfilerAgentTask;
      
      private var var_1206:ProfilerOutput;
      
      private var var_688:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1208 = Component(param1).events;
         var_413 = new Array();
      ...
      {
         return var_224[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_224[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_689 = new SkinContainer(_loc3_.content as XML,assets);
         var_688 = new WindowRenderer(var_689);
         var_224 = new Array(const_360);
         var _loc5_:int = 0;
         while(_loc5_ < const_360)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_688,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_224[_loc5_] = _loc4_;
            _loc5_++;
         }
         _windowContext = var_224[const_1082];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_333,_loc6_);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1291,_loc6_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_224[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_224.pop()).dispose();
            }
            var_224 = null;
            while(false)
            {
      ...
      {
         return var_224[param1].getDesktopWindow().getChildAt(_windowContext.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1206 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1206 = new ProfilerOutput(_loc3_,this,var_688);
               var_1207 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1207);
               var_1209 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1209);
               var_1019 = true;
            }
         }
      }
      ...
      {
         return var_689.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_959.length > 0)
         {
            var_1208.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_360 - 1;
            while(_loc2_ >= 0)
            {
               var_224[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_1019)
         ...
         var_1208.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_360)
         {
            var_224[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_1019)
         {
         ...
         if(WindowContext.var_959.length > 0)
         {
            WindowContext.var_959.flush();
         }
         if(WindowContext.var_1399.length > 0)
         {
            WindowContext.var_1399.flush();
         }
         var_1208.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1414,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1182,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1274,param2.name + ": " + param2.toString());
            }
         }
      }
   }
