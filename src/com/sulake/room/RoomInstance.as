package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(var_243.getValue(_loc2_) != null)
         {
            _loc3_ = var_243.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      public function dispose() : void
      {
         ...
         if(var_243 != null)
         {
            ...
            {
               _loc3_ = var_243.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      public function createObjectInternal(param1:int, param2:int, param3:int) : IRoomObject
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_renderer != null)
            {
               _renderer.feedRoomObject(_loc5_);
            }
            return _loc5_;
         }
         return null;
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(_renderer)
               {
                  _renderer.removeRoomObject(_loc4_.getInstanceId());
               }
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         if(var_243.getValue(_loc2_) != null)
         {
            return var_243.getValue(_loc2_) as IRoomObjectManager;
         }
         if(_container == null)
         {
            return null;
      ...
      {
         return var_243.getKeys();
      }
      
      protected function getObjectManager(param1:int) : IRoomObjectManager
      {
         return var_243.getValue(String(param1)) as IRoomObjectManager;
      }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(_renderer)
                  {
                     _renderer.removeRoomObject(_loc6_);
                  }
               }
               _loc4_++;
            }
