package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_746:Number = 64;
      
      public static const const_886:Number = 32;
      ...
      private var var_1598:Number = 1;
      
      private var var_2388:Number = 500;
      
      private var var_1596:Number = 1;
      
      private var var_87:Vector3d;
      
      private var var_86:Vector3d;
      
      private var var_2389:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_86 = new Vector3d();
         var_1117 = new Vector3d();
         var_1597 = 1;
         var_1596 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1598 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:* = 0;
         var_244.assign(param1);
         if(var_244.x != _loc2_ || var_244.y != _loc3_ || var_244.z != _loc4_)
         {
            ++var_80;
         }
      ...
      {
         if(var_449 != param1 * var_1598)
         {
            var_449 = param1 * var_1598;
            ++var_80;
         }
      }
      ...
      {
         if(var_448 != param1 * var_1597)
         {
            var_448 = param1 * var_1597;
            ++var_80;
         }
      }
      ...
      {
         if(var_450 != param1 * var_1596)
         {
            var_450 = param1 * var_1596;
            ++var_80;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_447 != null)
         {
            ...
            var_447.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_447.add(_loc3_,_loc4_);
            ++var_80;
         }
      }
      ...
      {
         return new Vector3d(var_244.x,var_244.y,var_244.z);
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1117.assign(_loc22_);
         }
         else
         {
            var_1117.assign(_loc17_);
         }
         ++var_80;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_450;
         _loc2_.z *= var_449;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1117);
         if(_loc3_ < var_2389 || _loc3_ > var_2388)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_450;
            _loc2_.z *= var_449;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1117);
         }
      ...
      {
         return new Vector3d(0 * var_448,0 * var_450,0 * var_449);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_447 != null)
         {
            ...
            return var_447.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_448,0 * var_450,0 * var_449);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_86;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_448,param2.y * var_450,param2.z * var_449);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_448,param3.y * var_450,param3.z * var_449);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_448,param4.y * var_450,param4.z * var_449);
