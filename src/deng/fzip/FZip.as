package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               ...
               case 101010256:
                  ...
                  break;
               default:
                  dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_114,"Unknown record signature."));
            }
            return true;
         }
         return false;
      ...
      {
         return !true ? var_129[param1] as FZipFile : null;
      }
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_114))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_114,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_93 && var_94 == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_114,"EOF"));
            }
         }
      }
      ...
      private function parseLocalfile(param1:IDataInput) : Boolean
      {
         if(var_495.parse(param1))
         {
            ...
            if(false)
            {
               var_129["null"] = var_495;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1385,var_495));
            var_495 = null;
            if(var_94 != parseIdle)
            {
               var_94 = parseSignature;
      ...
      {
         var _loc2_:* = null;
         if(var_47 != null && var_129 != null && param1 < var_47.length)
         {
            _loc2_ = var_47[param1] as FZipFile;
            if(_loc2_ != null)
            {
               var_47.splice(param1,1);
               delete var_129[_loc2_.filename];
               return _loc2_;
            }
         }
         return null;
